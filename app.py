# VERSAO-SIGAD-CARAJAS: 2026-08-31-COMPRA-33-ITENS-01 (se voce ve isso no GitHub, esta versao esta certa)
import os
import re
import secrets
import string
...
from flask import Flask, render_template_string, redirect, url_for, request, flash, jsonify, abort, Response
...
# Logo do ICMBio (recortada e redimensionada para favicon), embutida direto
# aqui - evita depender de pasta static/ separada no repositório
FAVICON_PNG_BASE64 = (
    'iVBORw0KGgoAAAANSUhEUgAAAEAAAABACAYAAACqaXHeAAAdRElEQVR4nM17eXwV1dn/9zlnZu6eSwIk7AgCITesBkRECFQRRQUh'
    'XNCqdX3VtlatS+tWr6m7LXVvFbdq1SoXFRTr+gJxAVRSFk1YBMK+hIQsN3ebmXOe3x8JiIrFtw39/L6fzyQzd+bOOed7nu08z7lA'
    'O2Du3Kg8cE5nRV4PRItrUNrbC4Dajv9vIY74RKz1mUBZUXHw3EHvBKdFZiAKCYBwWr8cX1nhiJkz4+qxuZHgJ6uOe/SkYuOMdEbb'
    'hcd6TQCIzo2KWCwmfj37BN9bnxw3ttO5Rf0D0cLBODI5tHhxqRGL/Yg+Hk3EYhCIxQRKe3fwTCuc758RSSLawwcGdZhVNLXgkiH8'
    '/LtDH/6samhx1c5RPH/piJZx14wcffC7bTg40slFz/unF33R+vJS478+oO/gR4vnyfec3THJPGlXTc2ynU+vqVEALr2naPLo0aG3'
    'h/dkLF/pjOnVGf2W7ww9XNdiGB+tarxs7V9Wvnr+7DFDu4XgPvBM7eB7bwqXdfPay65+2Vo8tm+X9QvLF6YO7QtzjIByJgL/Y0M/'
    'T8AOn5NsxCeTT6rcFItBlJdDtzcBR5yB82ePGTrSCK37e5JuCPXseFNic12FKu37avT0kpffWrtrwOBBqbl19cJaVdvh3SWb+SNT'
    '4v3cDly6e789fupdJ7qhHHNuQiE1bERgafEx4tRjA6bVp3/vG5os9UjpfdNebNjX0rDmjx+kQGCicp47NypLY7Uk9jf9qnfE+4cN'
    'ydRSAGPae+AH8MMSwCAQ+NKHx94R4NSzb23uWFg0IHhey87NUcfhHTK/HwuP0bexwX3c2rv30RNHmFW9OjreIV3SP43Ozoxuyaou'
    'N04teCFjyAVMQvQMiTFOatcp81bISMZ/zBtCpTemMk5m00OLqwDg3aWRPAjPnwo8+trhw1c3vrts+KyCrtbf9tXafz/1+JUXMkMQ'
    'tb8EHEkFCADnndcvZ/9+477rZnbcXTYye6t2teex5V2xsd4LnwfoqpuHXzJ239/DObJQAnihwm14/C17TsiH6i5d/XOG9PA8+OdL'
    'Gu8pmMVzqIt1Lu9vutCf4/+N1pp6dM8/PyCoJtwlOKFb2L3HVO5JG5qDF312q/XQwiUbB+zPqm3eUwszUcQ1Ebi9CTiSheXSWKmx'
    '/6WNid4Dej/w8c786/YmLQ+Rhu1Q1uMzkEjoit+eUR8Kh42BjQmtUjbotGFC5uaAXaJHdzXY3lMHJc/eWufd/KuZnqn9c2VycP/c'
    'IUrIYsNvRYIdgp+FeuWvSWZo3yuPnTDybxsiLQLoSDRPnTl+5dqfTVqTnElxRQRu80jt6laPRAC1dCskxEBT+iaTx3ibrwxzy8lh'
    'kRy2usa5eMuGLe66qo19fzknO851OJWXaxi5Puaq7RxOknmzoyjnhF7q05GFRpHN1PmMEinPHJ3nHRPJCRp2albQn/OML+glBe5p'
    'GaL/Ndd+OP3SAavHLbt1wS29zx3YGwA+WD7kkneXDfs5AKJWI9iuUnAkI8iVV8xxACD7GD3dIxdTrn01f8he7pls3vLJMcJrkWWJ'
    'npVb+Mqwoadsb8Rdy9fpkc8ucljYzNIEtjV45+/cLzvl+Jy+m/b7PYksoXs4e9LKh3JGzV+R3hCbu5lJO87YQaEbpD8Y8WhHnXTD'
    '8bcsXZ+4bXLshPfZVGWGdtYC+It3evFZWrlfZoet34ZycHuQ8UMEEAAu+W007O/s/o6F78+ktv3NbrGTuV1y/x5ES/8N9TlPpFxH'
    '2hnXtTyi29DrsqehVv2K+lpfeABIAW16LRHq3uMP91fI9KRjG0/ZvNO5OG1ndo4ZnN1Mfs8zDcnMsHTahscETEkRlVHwhr2yZ767'
    '53gEFvbrn3PuB19l2c4q99H5w7s98Z5dX/WX9TuwABrtpAqHVYHo3KgAQMLvRDiYc31zbe2TTy7Yc83KmnRx71C2ONeTMU8dFlAy'
    'az967/kWRvUT8ARwDv+py6qQUM+YFjkshRCMt30eo0YxNdw3L3Hc84vrB7+2vP4nZX+yv3zz4/T0J95zEfASS0G8piaFRFptc5sz'
    'L738m0//Nn5weLuyFRqTRPVJo0OehyNnlVAfa+aQx3OikdOAgzbhP8IPskgABp8/JHDhrNxXDUqfcderSRT3CWFIDysDKcyWFFc9'
    'c1XtlFWbg1scEqipyTw96wG7KVxgTXKSTpU06JHEq1VLR/1+yjVE6Pnlmk0XkiU6CUOiuc7+Em9XD6GzIsstvxilbc1KY4/OqBMt'
    'r7hB+IwxfUL8aFKJGITodMVP/LMnH5/ZPCmWvbrZ9Aw3kpmdLajujfhBt/hvq8L3GYy2LmzCsyJXrUnoL7KJ/WOnHE944Sqr+bje'
    '1np4PV7TZ0qD1cqZD3fnXbvteSLrrHmhQnU2w+b12tWDhEFTEq9WLT3pgbLzzZD3IdPvub5Xn665OuM6mWZHnTPO6L9m04i/Xj2R'
    'Hizq5ts8cVQeTSgO3Aei3t6O3l8akoY1idA1dSnriQJv5s6JwzOzvD7zuTNHyGFOk52WhDcRh0asVVX/3cED/8IIuhqneTp6il6o'
    'yMRPGeq4u2pV5ZuLmrdOm9Rp3P56J7w+mddXWZ7K3y3JWdrR4z/xg+UrfhrMt85UaeXAkD7flAF/dLLuGNMQrB3X7ZAXNHfsMKWh'
    'FLqEwRlNFw4pDE5LS58M+AXrzsYtjUl95ZptyW35+R26DBzce0hdvaLfn771b9JLA7bttJuvmOwJDeqVvfe6sq/uZI5Korj6TwYP'
    'HE4C4nENACbwC5mxryjq2WHh8ys69XppaXDvxi2p5B8eqX7ui325yykYGAvbycvp5JuSsFvuiL2/7plJxYHms0bneX0S7JjG9du3'
    '1x7LribX9JipDN2X2N5YojR2P7RAy/vnpt26hJHjggKJpGOzaRRMGNYh46TdCiZYylZsGQo1tWJlpjnb3KmzlZNKaz45Ys4HQECk'
    'Xdzh4SSAAaApXr1NA3MKHh/3ctfegTE+5VRVVBnNvo75NzipRB2yBjQjoxxlWZbwvX3ntOsGdkdugV2fCfmEO3JQTjBIamVNxn34'
    '+J5Np3hzMumJl/a/8fVP6gI7DKbXlmSv7x62NhqWWBAI+jx2c7bm1WX7B/o7+C5orGtyVqSUkU1mK35x65oPb/r7hD9OGd6Sk2hW'
    'CyeMW/VlLAZBVN4uYfEPqkBZNCrjtbXkOOq+vVubmwMsHmDikarFfl930K8oVz1pBTx+ZbvYvml3vTec+3lzi3Wzaxt67/7kyzPG'
    'dVyUzSBw57iNaWWZV39e45NfbCGcMiIXy6ua7pl9rTevY37y5//7BT25LR3a+NgVPZ597oPaq2TAguuQM7R71jSVM6DlzmnPVdT5'
    'z3n1ucz9Nfe/VhGdG5XlM/9z0T+Af9uXHve7M0qCucGSr7/afEIT3Itlwvnz4JLCruw1JtiNqVtqN28a5ErLP2OY+9foBO9Tn2+y'
    '+lRvNx3Dkr7ignTVyH7ZYsNvoqHO3jfr4cw/GxuwCNvVu+hjfXHZqYb181OkTts6+/DS7r49lAdubFp0dV/r1MeraqkCFRrttDQ+'
    '4nI4FoPA+FJxx/gKRXe0EVYdpX/eGa8EUInJ/T/2hayeOeFgneGVv5BSIOHYf97bwjB9Go8v0qNX7aDywQO8z+bmG766PdnakMde'
    'YvqN4myL7QpBnf0+c5L00KTfXS66P/euc8G4IrqZDTHM75W+aGTPI3dX+LbkUfObM2cuVoFo0cwAF09OouoixCD+UyKOSEB5OTTK'
    'K3R562Wb4YkDsZgoxRJRUV6xNg1M3Amgx11dUlnX/cWu7bVdDIIkWylP0CxcuiExcFQ/M2IZobGd/Lri4tMrtyz9ssRTm6BL5n7i'
    '2rt2uMZZJ8rMRVNzrh7drzm5dSei9c34wGB308ur8utX3x5/8EB/LGTfSzu+Za2d+89D4fYIJwkxEOIRA9XVtjml//1W0PsbcnTW'
    'cdkY0MOnRhQGHK/Ac395fdc8K8cqNyzRJVXvPBjsIC/NkDHSUK4bDpL45UTxdse88OynV3Z9wGuhT2Oj/au1OwIb8fxLK8HEOArL'
    '4fZbWkajsjRSS5Vr60aRIT9RzAiYhGmjOijDENLrlfi0OoGVNWl4DAAMqLSKSQ9dojV6FnTvDMMT+iIYMJuDYWOia2sI16n701lb'
    'bq1tkZVnvnPWyhjKUf7NrLcLGe2XcY3HVQUqdMvcqk9TDS0nO1n3fa+kf1oeQ7IQYAAGATrj2uzqFBkCXr9oTDRlh3Tt1eXenn0K'
    '0CXfGhUIiImcVewIA0VdbLtXH/+TQVPfgfJyPX58qQDaZxV4AEcj5UwnTBh27piThvx5+3OrS1TWudFj8ko7reZt2J6u9OZ6LOEx'
    '/KkWN71/hf0+Qvckj+3iX5OxFRgCLc3ppt3b91VJ2/3j4mV7Pnx4bnLnRzW5S0f+/qziJePHa3D7JkTat2jRmkfECXdNfTDRnNyy'
    'YfOOPb17HrOloMA39NPNnZ/FnEU+nOW5A4pD542TTdeVeXq/s8Icum2/J3e/bTnr9onMrh17eyWTGTe7PznG0yH4VLbZ3TFiwpAO'
    'Eu6Wz26b/7PSWKlRUV7htleX2zcv30bn8tsWXGtNHfBFuHN4RH6BD1bYh6Hd6ka8uDb4nL+jp0/DXvftpIMzOnU2zh7Q1cWWBi96'
    'BLPp1VX7GxMpLX1+S5pCjswz6WRvZ1d2DWblvoasAwAV5RXtFgQB7U1AKwW64znDu6WczAhDShgeE66rkeNRx9cncUrWR8ewB2dT'
    'JnPbJ/8Uo7/e48llpQSFLN+ogeHHNi2pG4CAOZVZT9v2cvUTALABGw5to109QXvbAI0YRP0rK3cB+HlLY/LDVFPqBSetPvBz5ndC'
    'kuMkbXy508cPLu0VfqvSX9mg/BZIUDKp96/dll6vm+0btaOaGGgCQIhCotUBHpUa43+lcHn1QyMGZX2hFwoCdqR7J1X/9IqunY2A'
    '1zQyLW8O67B/V/fuxv+EOPPKL59o+EuvYzzVdVubPanA1n2IQ7X1sd39/wEcPQKikNFIVEYQcfcWLH7R18F7bropi70tZtUuN6dv'
    'IGR6mhpVxYpbF5391fZ+Tfv22etOKVlV1K4+7kfgqFVeSyOlVItaXb5kidjX4GzQjoZhCtXZk/xtY2NqUUtLhndv2dajc1lBwaq1'
    'zpUtGfxMA7j9m9z/f0U6j3oj4eiAPllX3BgdnfeeNOWJeR1M+6UPa89q0jRUMkNk9dTEG8mP5n/iVQL+QVNOWrnsaPfpULS3BBAA'
    'DLl+YmDUnVOuO+0fv/I0xTfUEInk6/9svh0ClwiPvG3C0JxjyVaLVVr9NvlG9ZuCtjb6TN90r4W/AiA+SgbvcDgq9XkK+k0SVLh1'
    '4You3slFkJKuNzyStBRQrkbGzDGOG9MzYGq3csmCtVR6e6ncIlte7unKNwAw/Rf3lByNpg5YbWGcXVTjMSiTyepPyGvM6NfJXDh1'
    'ZLjqo70dbvB16ZCb3Nnw6We3LTgpOjcq4+2Y5fm/oP2NYKxNDa46vnffHv5eSsGZeWLeP06JBH657r0Nv75/wZ78xvrmN91E+jNW'
    'fC8YFJ8ZV6Pvmlo++u6pDwBA6b+zc4RB/852msM19F2pOJxXogMD/V6NrjVDQxccH65d35CdtYbUVwUF3qp8hU1LRkQKrDy+ZvOG'
    '7Zev/eOiiwAg+lVUxhHXzPyxAkkAlF+d/902CdGoaMtYH95LEri89R4hCtFWNGlnjxqDaNsg9W1Eo/KHylTMUfmTW46vuODBsYvO'
    'eWxSdadzB5V2PbPEj1isde/RDyEa/X47rfjWBMXa3nH5o2OPu+yRsRd964EfYUy//0D0BF8Omn0A0IycNOLL062fQ7ZFZgidPbCj'
    'JnQlSyqrKbtz/7sbm1t705qjyzuvXw7VSN6/dH3iZ7He3uc/8j390FWmOXV8YKbdnB5e2Gf1KuaYICrnnEsjuZSWrNiSACDJVk3O'
    'l83figJLe3v9XcPjKalXJt/6ai++HR0SAI7OPiEv5KHQs/P3Wv5c7+xUg7oSH67fhSNEkt8QUFpqoKLCDUQjd8GUvwAAZN0nkq+t'
    'vQXRiIV4te0/e2AJmcbNTDyeGHkANAi1ILzrZtzfZxes3wIA/rKiF8ljjEciOzn11oY1M+ZG5cXdvz7OHzKmrF7nPnJN1ar6fp/1'
    'M3eFrHdIyqGslHuwo0REoAZm/VIK1XcjDhUoi7xAQesCnbTXmo55YtOC1U0H5/jATFPrQqzvVWNvbGhJPdDb01R8/dS8HRc893kS'
    'cWhm0OG22HzPBjAjJATlAoAGggCAeLUdmF40C5Z8gYSw4ChAEABIMHclQ14svZjsn1Y8KfVG1Woi6kSm7M4+8y3vGf1PjM+M74wD'
    'X6D1IAC8a7r1tPCYEzjrQpjGgfcBSoM1d5Y+q9zfEuEUqu9kUIkgAklRlM04OQAaEYNAdVQgHlcgMAHMAPI7d/y8SfYf+PRllac3'
    'Z7L5iOOW2OJSg+jwOYTvG0EiF5q57ZwBwD9t4HEwxYvQkKyUgiEkXL0HzC6k6MG265IhC2CohZg4ZCCgFLJKkxS9hN98A9EepaWR'
    'Y50QWqyF5ZUp//RITPiM8znr2hBkatv9mAhfQ5Ng4hNIUH+ddQmEixDFPaT1TOWom9nWczMLq7d9kw6PA4DseM7wgvqEm77ktJDP'
    'Z+2/aWhe3ar1dcbs99fm9ovEosHfT4i3LFwyvChVu3LDzJn4lrv9vhHig3E4gUkAAElRToY0wNqFIMWuvsybdQckM75C7ahpEOQQ'
    'ARCi2RNKF4DgQpJgR2fJMkb6OeflivIKd2F5Zco/beBlwmvcwbZyASYyBbHC7GS8+rLka1WXCJfKQGSgNRz0IrdEQPNEcvQuIflE'
    '/7SBXds8j/BHI78NzBz0ZZbtasNw163elF0ezvWdZniMm57/uGP3r9N5y7TWt69dN+DkwSOD1eFex10KAIsXf+Nm/4W/JRBxBtGI'
    'BY2T2VaaLMPUKWd26o21zxzY4ZgG5vvOLjpXeoSVfPWreQBYzogEiBkgNjjrOsJrnO0vK3pSaPqALfEUu0qBIUHQ0AxBGOWdPqDe'
    'ICmYeQpAII8pddL+GHMqHcyIXCf8Zk92BJCyXwSw218WeVl4zXPYVoCUsPwCW+tsfFXTomDr+eFA5w1Jx/mD0MabfuKaPbuyj7ja'
    'WQYAS5ZU6G9GeQBtRtA/o/hPwhK/BhE4697jOuopw2vWQLOCFJJst7RFDvoUtbWEigrV5nPVQekhwD8j8r6w5CnsKAUi2aYqBhj4'
    'Rr0OyfIf0H9q+8OsoPXLyXTDlVi4Ox2YEVlBphjCrgYDPQEMEx7zHbZdGyCLtf6IiIQGTtIMaFdvdrQehjfXJ354gn9IBQ4Fgy0i'
    'CweCc2Yow7ARj2vkV7QGQAd2acQgcEfE/B6xGllIacDVLpR2IahNvTh98CmtFZR24Gqn1ZRBQFB/vy93QGurMABqPVxNYJwHrTUE'
    'Waz1Lal51aXJeNVYAb7bNAU8fqOvX9K40lipgctLTGbQYj78xusfJoABEBkJzbuhtAKDSAqQ4wwAwKgtNXF5iQmAcWZXP3aXSJRX'
    '2620MbEGyJCSoW9nW71IPtNotSNo1gpToGk9BIEMAda4VWguFq4eBEedA80psowTwJiH0/p5CAcljJWtfCDqBiLBjm4K7MOjuLzE'
    'xOUlpnblE+woB0TMgnpWlFe4WB9kIvAEqnAPt9f4X0gAg8E+vLk+AebVMASx0hqGuMk/OdIFFRUZzKl0EO3h8/vy3g00Zb70zxr0'
    'oGd6/75ElGk1owRB1Jh6vfoCzjhPM3gLZ3Vp+vWqt5jY3xa4gpk2Jl5f+3Vi/roNydfXvsrMu9hWmqQ41u81BjFT8oBpJjJdYs6C'
    'mckQvmSeHoA5lQ7mVDpC6H4QQoKZiDj1w2P7Bv960cHc6gUI90JSnG3tkBRFCHBloCzyDwYcABNI0kCAICQVqox4GJJc+oZELwBK'
    'xqv/BycWhrB0faIt0dk6G5pZMB8fKCusBxvEpEeTpD6tIi4EkxTf6BNImpkMw/sZCTodSkuY8mVf2cBbJAnJAvdAgNnVELZYAQAY'
    'X6FR8cND/L4E0MHFDQPkAkBLvHqezrgPk9ewoBkgdCNLXiY88udEYiA0QJKgM/bl2QXrtzDDz3zwHQoAo6TExNL1CcQOGk0GEbPD'
    'Gqb4DQxzMSxaJCzjbigIsgwDLu9Jt8hqAvvAYICVaxgBKD2HbZUECUlAoTCN19iQcwH0I1NKVvxKy5vV1YhCHql8/n0CNCxIIkgi'
    'MCwAhAt7e1OvVV+rM/ZvGFRHhgDabBkZBBB26bR7ceq1dU8hCkkElwzR+g6wgRgEOncWbR3iNpq9kEQwhDx0RcKaAUmCld4Ezefh'
    'gzVJJuRACoIgaYCCqTfW7YajpoF5BxkSJAVIEkgKcMZZ6PXaV7QRfcS9A/Sdc/bOKu5JRAUmSWFn7b2Z19duPfQLudG+YQfeiRrU'
    'h4g1QWyymjOLDi6IAHiikX6mZVlK20HBYmvyla/2frfhQFlRsZZGSCg3wZI9rAwhhU65EGEBnU7Fq79Em/ELRQcXKkKAFYt0R89q'
    'zKl0AAAlMAN9i6cz+BiCSCviyszcqk8PHc//hYBWlJYasBo8+GBNEgC804t6G0BvU2ZXZ2RwoFSpzS3xjftyTo3kZX0qJ7tj/U50'
    'LTGDvqYAZWWeIulLLaheHZgWmZDc5vsYlZVOaEphoTKpv+mmP2nKmmmkLbNjWFH9m+sTwbMHljLZa5OGNxV0dEnL/HUVABD+6eDc'
    'pqDVEtyVCLPpCrhMSc4kgG7Ic5uMlMcTFpbIT8W/rAyf0StXkVe2+DY0BFTRhGTCXNbW/yOS8D0J8EUjx8PFcCIuJsKTWtNPiLgx'
    'lDBfT4TtMlObn9g604mk0REuukHQTsE6DUPkK6W3CyAECAWgGJL2JedVzQ1MG3g1MVY6goVBYjAzZYiQAFgyYBHUCmbjOCLOYeBj'
    'qXibElTOzGtBpElQB2heTYQgM8Yx0/sEdCQJm1ydZqIRTKKClHYhqSiZsp/CuxvtHyMB37MBrNgLqN3M3ATGKQbr98B8TCJo57Ar'
    '1glp1TOkhBa7SFCNVNyghejDIEnAVmk4NYCWBOwBWAJgDcBRehsUGKDOAIehNXOrcdujskZjW/lrL2v2JJJWBowsgfpC815i+FtJ'
    '1bXM3EiEkzV0WiskGGS0zp5ra9ddx+BwwC9PBMCHTd58B4e6QQYAydl1rmsETEctc/wUkiQ7gGhLqj7V4M8PcENtXTaYb24kB9px'
    'RUPSdfb6pDVMkVORNVKNISdoJ93ALp8nfTET3gLAksUKMsR4tp33raSzMhuy/EQ6LIVR6zq6TEq9XRhYqrQcl+7kr4SR9ug0PZyB'
    'r84jW/KhabtwnawyZZORdh7mgLer4cJVJvcXiv/XdbGNhM4Ypgwooh3awXoA+DFG8OggGrEOufr2euOwdufopOd/DA4XCdJ3jkPz'
    'gHSYZw7k7+jAf7/m53xTCqe03oMInzE4NzAj8rm34+5RgbLIW/7JkS4H3umfWjTZ36loMWIQKC01AmVF5wfKimYeuEZrAlbg0JJZ'
    '67k4+APOQ+8f+OxHon3rAtGoRDyuAtHid2CI0eyqgal49Z5ANPIuDDmJkqpYW7ScBKqTc6tO8EcjXUjKanbV3tS86iIA8EeLq8Aw'
    'U/OqBrTHPsAj4agURxncRKYMA3jfPyMyjzzGJNi6RUvtBfEusoxRgWhkIYD3yRS5BCQAUKCs6GQwewFWwWmRGSiH/hfZ4XbBUaoO'
    'U2edzD5GjO1EOF0l3SshYEIRE8OrE5mLGTQOjAbdYj8GIB8AM9FtRHgQLl+nBe4GAETiR7VafnQIYDYIqE/u6zyVgWOFEMtA8BBp'
    'F8QeGGI1Zah/qsU+lQTqmZHxTj22JxGNg6aJkDhfWHKAf3rR5KMtBUfL+mowBVBR4aaAPcHowELWUkMQg0kTVDj51tqVAMAzinII'
    '1Cil52qAPyOBm6FB7OosCboLwDuItM9vAw6H/weaStKITbQpWQAAAABJRU5ErkJggg=='
)
...
def favicon():
    import base64
    dados = base64.b64decode(FAVICON_PNG_BASE64)
...
app.config['MAX_CONTENT_LENGTH'] = 100 * 1024 * 1024  # 100 MB - base
# confortavel para uma solicitacao com muitos itens (ate uns 50 anexos de
# orcamento no total, em tamanho realista de PDF/foto escaneada)
app.config['MAX_FORM_MEMORY_SIZE'] = 5 * 1024 * 1024  # 5 MB - o padrao do
# Werkzeug (500KB) e baixo pra solicitacoes com muitos itens e texto livre
app.config['MAX_FORM_PARTS'] = 5000  # o padrao (1000) da folga curta quando
# tem muitos itens, cada um com varios campos + arquivo de orcamento
...
# CPF, RG e dados bancários são criptografados no banco, não gravados como
# texto puro - mesmo quem tiver acesso direto ao banco de dados não consegue
# ler esses valores sem a chave abaixo, guardada só como variável de ambiente.
#
# ATENÇÃO: se a variável CHAVE_CRIPTOGRAFIA for perdida, os dados já
# criptografados NÃO podem ser recuperados - guarde essa chave em local
# seguro (gerenciador de senhas da instituição), fora do Railway também.
_chave_criptografia = os.environ.get('CHAVE_CRIPTOGRAFIA')
if _chave_criptografia:
    _fernet = Fernet(_chave_criptografia.encode())
else:
    _fernet = None
    print('[AVISO] CHAVE_CRIPTOGRAFIA não configurada - campos sensíveis '
          '(CPF, RG, dados bancários) estão sendo gravados SEM criptografia.')


class CampoCriptografado(db.TypeDecorator):
    """Tipo de coluna que criptografa o valor antes de gravar no banco, e
    descriptografa ao ler - de forma transparente para o resto do código
    (o campo continua se comportando como uma string comum no Python).

    Guarda como TEXT porque o valor criptografado fica bem maior que o
    original (um CPF de 11 dígitos vira uns 100+ caracteres depois de
    criptografado).
    """
    impl = db.Text
    cache_ok = True
    ...
    def process_bind_param(self, valor, dialect):
        if valor is None or valor == '':
            return valor
        if not _fernet:
            return valor  # sem chave configurada, grava em texto puro mesmo (com aviso ja emitido acima)
    ...
    def process_result_value(self, valor, dialect):
        ...
        try:
            ...
            # valor antigo, gravado antes da criptografia existir (ou antes
            # da migracao rodar) - devolve como esta, sem quebrar a tela
            return valor
...
# a partir deste valor, um item de compra ou um prestador de serviço
# externo, SOZINHO, passa a exigir 3 orçamentos anexados a ele
# especificamente (mesmo que os demais itens da solicitação sejam baratos)
VALOR_MINIMO_EXIGE_ORCAMENTOS = 5000
...
def _shortcut_api_get(caminho):
    """Chamada GET genérica para a API do Shortcut. Devolve a lista/dict
    decodificada, ou None se a chave não estiver configurada ou a chamada
    falhar por qualquer motivo (sem levantar exceção pro chamador)."""
    import urllib.request
    ...
    requisicao = urllib.request.Request(
        f'https://api.app.shortcut.com/api/v3/{caminho}',
        headers={'Shortcut-Token': token, 'Content-Type': 'application/json'},
        method='GET',
    )
    try:
        with urllib.request.urlopen(requisicao, timeout=15) as resposta:
            return json_lib.loads(resposta.read())
    except Exception as erro:
        print(f'[shortcut] falha em GET {caminho}: {type(erro).__name__}: {erro}')
        return None


def listar_objetivos_shortcut(nome_grupo=None, nomes_ignorados=None):
    """Busca a lista de Objectives (objetivos) no Shortcut, ao vivo, toda
    vez que chamada - sem cache local, conforme decidido. Retorna uma lista
    de dicts {'id': ..., 'name': ...}, já sem os arquivados.

    No Shortcut, um Objective não pertence diretamente a um Team/Grupo -
    quem pertence é o Epic (por group_id/group_ids), e o Epic é que aponta
    pra um ou mais Objectives (por objective_ids). Por isso, pra achar "os
    objetivos do grupo X", o caminho é: acha o grupo pelo nome -> lista os
    Epics desse grupo (ignorando os arquivados) -> junta os objective_ids
    desses Epics -> busca só esses objetivos.

    nome_grupo, quando informado, filtra dessa forma. Sem ele (ou se o
    grupo não for encontrado), devolve todos os objetivos não arquivados.

    nomes_ignorados, quando informado (lista de strings), remove da lista
    final qualquer objetivo cujo nome bata exatamente (sem diferenciar
    maiúsculas/minúsculas) - serve de válvula de escape manual pra quando
    um Epic do time também está vinculado a um objetivo de outra área."""
    objetivos_brutos = _shortcut_api_get('objectives')
    if objetivos_brutos is None:
        return []

    objetivos_por_id = {
        item['id']: {'id': item['id'], 'name': item['name']}
        for item in objetivos_brutos
        if not item.get('archived')
    }

    ignorados_lower = {n.strip().lower() for n in (nomes_ignorados or []) if n.strip()}

    def _sem_ignorados(lista):
        return [o for o in lista if o['name'].strip().lower() not in ignorados_lower]

    if not nome_grupo:
        return _sem_ignorados(list(objetivos_por_id.values()))

    grupos = _shortcut_api_get('groups') or []
    nome_grupo_lower = nome_grupo.strip().lower()
    grupo_encontrado = next(
        (g for g in grupos if g.get('name', '').strip().lower() == nome_grupo_lower),
        None,
    )
    if not grupo_encontrado:
        print(f'[shortcut] nenhum grupo/time chamado "{nome_grupo}" foi encontrado')
        return []

    grupo_id = grupo_encontrado['id']
    epics = _shortcut_api_get('epics') or []

    ids_objetivos_do_grupo = set()
    for epic in epics:
        if epic.get('archived'):
            continue
        ids_dos_grupos_do_epic = epic.get('group_ids') or (
            [epic['group_id']] if epic.get('group_id') else []
        )
        if grupo_id in ids_dos_grupos_do_epic:
            ids_objetivos_do_grupo.update(epic.get('objective_ids') or [])

    return _sem_ignorados([
        objetivos_por_id[oid]
        for oid in ids_objetivos_do_grupo
        if oid in objetivos_por_id
    ])


def listar_epicos_shortcut(objetivo_id):
    """Busca os Epics do Shortcut vinculados a um Objective específico, ao
    vivo, sem cache. Retorna uma lista de dicts {'id': ..., 'name': ...},
    já sem os arquivados. Devolve lista vazia se não achar nada ou se a
    chamada falhar."""
    if not objetivo_id:
        return []
    ...
    return [
        ...
        for epic in epics
        if not epic.get('archived') and objetivo_id in (epic.get('objective_ids') or [])
    ]
...
def salvar_anexo(solicitacao_id, arquivo, tipo_anexo='geral', diaria_id=None,
                 item_compra_id=None, prestador_id=None):
    """Grava um anexo no Storage (ou no banco, se o Storage não estiver configurado).

    diaria_id, item_compra_id e prestador_id são opcionais - usados quando o
    anexo pertence a uma pessoa/item específico dentro de uma solicitação com
    vários (relatório de prestação de contas por diarista, orçamento por
    item de compra ou por prestador de serviço).
...
CHAVE_NOTIFICAR_APROVADOR_EMAIL = 'notificar_aprovador_email'  # 1=envia, 0=nao envia
# desativado por padrao (0) - a integracao encontrou objetivos/epicos
# arquivados ou de outra coordenacao aparecendo por engano; fica pausada
# ate o Admin reativar pela tela, depois de alinhar com a equipe
CHAVE_SHORTCUT_ATIVO = 'shortcut_integracao_ativa'  # 1=ativa, 0=pausada
...
class Coordenacao(db.Model):
    ...
    # nome exato do Team/Grupo correspondente no Shortcut - usado pra achar
    # os Epics daquele time, e a partir deles os Objectives vinculados
    # (Objective nao pertence a um time diretamente no Shortcut, quem
    # pertence e o Epic). Nomes das coordenacoes no SIGAD nao batem com os
    # nomes dos times no Shortcut, entao o Admin mapeia manualmente aqui
    nome_shortcut = db.Column(db.String(200))
    # nomes de objetivos que NUNCA devem aparecer pra essa coordenacao,
    # mesmo que algum epico do time aponte pra eles (ex: objetivo
    # organizacional amplo, vinculado por engano) - um por linha,
    # comparacao exata (sem diferenciar maiusculas/minusculas)
    shortcut_objetivos_ignorados = db.Column(db.Text)
...
class Solicitacao(db.Model):
    ...
    # vinculo opcional com um Objective do Shortcut (ferramenta de gestao
    # de projetos) - guarda o id e o nome (nome cacheado so pra exibir sem
    # precisar de outra chamada a API toda vez que abrir o detalhe)
    shortcut_objetivo_id = db.Column(db.Integer)
    shortcut_objetivo_nome = db.Column(db.String(256))
    shortcut_epico_id = db.Column(db.Integer)
    shortcut_epico_nome = db.Column(db.String(256))
...
class SolicitacaoDiaria(db.Model):
    ...
    # sem "not null" - uma solicitacao pode ser so de Auxilio Deslocamento,
    # sem diaria nenhuma, e nesse caso nao ha data de ida/retorno de viagem
    data_ida = db.Column(db.Date)
    ...
    cpf_diarista = db.Column(CampoCriptografado)
    telefone_diarista = db.Column(db.String(20))
    email_diarista = db.Column(db.String(200))
    banco_diarista = db.Column(CampoCriptografado)
    agencia_diarista = db.Column(CampoCriptografado)
    conta_diarista = db.Column(CampoCriptografado)
    chave_pix = db.Column(CampoCriptografado)

    # prestação de contas É POR DIARISTA, não por solicitação - numa mesma
    # solicitação com várias pessoas, cada uma envia o próprio relatório de
    # viagem e tem o próprio CPF bloqueado/desbloqueado independentemente
    # das demais (mesmo protocolo, acompanhamento individual)
    data_relatorio_enviado = db.Column(db.Date)
    relatorio_em_conferencia = db.Column(db.Boolean, default=False)
    motivo_recusa_prestacao = db.Column(db.Text)
    prestacao_contas_entregue = db.Column(db.Boolean, default=False)
    prestacao_aprovada_por = db.Column(db.String(200))
    data_prestacao_contas = db.Column(db.Date)
    # decisao do Aprovador sobre ESTE item especifico - por padrao
    # aprovado; so muda se o Aprovador reprovar item a item
    status_aprovacao_item = db.Column(db.String(20), default='aprovado')
    motivo_reprovacao_item = db.Column(db.Text)
...
class SolicitacaoPassagem(db.Model):
    ...
    voo_ida_numero = db.Column(db.Text)  # texto livre - as vezes a pessoa lista varias escalas/conexoes, nao so um numero de voo unico
    voo_ida_saida = db.Column(db.DateTime)
    voo_ida_chegada = db.Column(db.DateTime)

    voo_volta_companhia = db.Column(db.String(60))
    voo_volta_numero = db.Column(db.Text)  # mesmo motivo do campo acima
    voo_volta_saida = db.Column(db.DateTime)
    voo_volta_chegada = db.Column(db.DateTime)

    observacao_voo = db.Column(db.Text)

    cpf_passageiro = db.Column(CampoCriptografado)
    rg_orgao_uf_passageiro = db.Column(CampoCriptografado)
...
class SolicitacaoCompraMateriais(db.Model):
    ...
    nome_especificacao = db.Column(db.Text, nullable=False)  # sem limite - titulo de produto de loja online pode ser bem longo
    fornecedor_sugerido = db.Column(db.Text)  # idem
    forma_aquisicao = db.Column(db.String(10), nullable=False)
    link_produto = db.Column(db.Text)  # sem limite fixo - links de loja com parametros de rastreamento passam facil de 500-1000 caracteres
    ...
    # decisao do Aprovador sobre ESTE item especifico - por padrao
    # aprovado; só muda se o Aprovador reprovar item a item
    status_aprovacao_item = db.Column(db.String(20), default='aprovado')
    motivo_reprovacao_item = db.Column(db.Text)
...
class SolicitacaoAlimentacao(db.Model):
    ...
    forma_entrega = db.Column(db.Text, nullable=False)  # "Retirada no fornecedor" (23 caracteres) ja passava do limite antigo de 20
...
class SolicitacaoLocacaoVeiculo(db.Model):
    ...
    especificacoes = db.Column(db.Text)  # sem limite - texto livre, pode ser longo
    local_origem = db.Column(db.Text, nullable=False)  # idem
    percurso = db.Column(db.Text, nullable=False)  # idem
    local_retorno = db.Column(db.Text, nullable=False)  # idem
...
class PrestadorServico(db.Model):
    ...
    nome_servico = db.Column(db.Text, nullable=False)  # sem limite - texto livre, pode ser longo
    fornecedor_sugerido = db.Column(db.Text)  # idem
    ...
    # somente PF, opcional - data em que a atividade efetivamente começa e
    # termina (nao entra em nenhum calculo, so serve pra referencia)
    data_inicio_atividade = db.Column(db.Date)
    data_fim_atividade = db.Column(db.Date)
    ...
    cpf_prestador = db.Column(CampoCriptografado)
    rg_prestador = db.Column(CampoCriptografado)
    telefone_prestador = db.Column(db.String(20))
    pis_nis = db.Column(CampoCriptografado)
    endereco_prestador = db.Column(db.String(400))

    banco = db.Column(CampoCriptografado)
    agencia = db.Column(CampoCriptografado)
    conta = db.Column(CampoCriptografado)
    chave_pix = db.Column(CampoCriptografado)
...
class ItemRancho(db.Model):
    ...
    unidade = db.Column(db.Text, nullable=False)  # texto livre digitado pelo Admin no cadastro - sem limite fixo
...
class SolicitacaoRancho(db.Model):
    ...
    data_entrega = db.Column(db.Date, nullable=False)
    local_entrega = db.Column(db.Text, nullable=False)  # texto livre - endereco pode ser mais detalhado que 50 caracteres
...
class ItemSolicitacaoRancho(db.Model):
    ...
    unidade = db.Column(db.Text)  # texto livre - mesmo motivo do campo acima
    quantidade = db.Column(db.Numeric(10, 2), nullable=False)
...
class SolicitacaoSeguro(db.Model):
    ...
    local_origem = db.Column(db.Text, nullable=False)  # sem limite - texto livre, pode ser longo
    percurso = db.Column(db.Text, nullable=False)  # idem
    local_retorno = db.Column(db.Text, nullable=False)  # idem
...
class ParticipanteSeguro(db.Model):
    ...
    cpf = db.Column(CampoCriptografado, nullable=False)
    rg = db.Column(CampoCriptografado)
...
class Anexo(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    solicitacao_id = db.Column(db.Integer, db.ForeignKey('solicitacoes.id'), nullable=False)
    # preenchido só quando o anexo é de um diarista específico (relatório de
    # prestação de contas), numa solicitação com vários diaristas - permite
    # saber de quem é cada relatório sem depender do nome do arquivo
    diaria_id = db.Column(db.Integer, db.ForeignKey('solicitacao_diarias.id'))
    # idem, para orçamento vinculado a um item específico de compra ou a um
    # prestador específico de serviço externo (quando esse item/prestador
    # sozinho ultrapassa o valor que exige 3 orçamentos)
    item_compra_id = db.Column(db.Integer, db.ForeignKey('solicitacao_compras_materiais.id'))
    prestador_id = db.Column(db.Integer, db.ForeignKey('prestadores_servico.id'))
    ...
    diaria = db.relationship('SolicitacaoDiaria', backref='anexos_relatorio')
    item_compra = db.relationship('SolicitacaoCompraMateriais', backref='anexos_orcamento')
    prestador = db.relationship('PrestadorServico', backref='anexos_orcamento')
...
def arquivo_grande_demais(erro):
    ...
    mensagem = (
        f'<h1>Arquivos grandes demais</h1>'
        f'<p>O total de arquivos anexados nesta solicitação passa do limite de {limite_mb} MB.</p>'
        f'<p>Volte, reduza o tamanho ou a quantidade de arquivos (ex: comprima os PDFs, ou envie '
        f'fotos em vez de scans de alta resolução), e tente enviar de novo.</p>'
        f'<p><a href="javascript:history.back()">« Voltar</a></p>'
    )
    return mensagem, 413
...
def notificar_aprovador_por_email():
    # por padrao continua enviando (1), a nao ser que o Admin desative -
    # so afeta o e-mail de "nova solicitacao aguardando aprovacao"; o
    # aviso dentro do proprio sistema (Fila de Aprovacao) continua igual
    return obter_configuracao(CHAVE_NOTIFICAR_APROVADOR_EMAIL, 1) == 1


def shortcut_integracao_ativa():
    # por padrao comeca DESATIVADA (0) - pausada ate o Admin religar pela
    # tela, depois de alinhar com a equipe sobre objetivos/epicos
    # arquivados ou de outra coordenacao aparecendo por engano
    return obter_configuracao(CHAVE_SHORTCUT_ATIVO, 0) == 1
...
def bloquear_se_travado():
    ...
    Uma correção (via "Corrigir e reenviar") passa pela MESMA rota do
    formulário de criação, só que com corrigir_id preenchido - por isso
    verifica os dois lugares onde esse id pode vir (GET, ao abrir o
    formulário já preenchido; POST, ao reenviar) antes de bloquear."""
    eh_correcao = bool(request.args.get('corrigir_id')) or bool(request.form.get('corrigir_id'))
    if eh_correcao:
        return None
...
def preservar_preenchimento(form_html, dados):
    ...
    (function () {
        ...
        ['calcularPernoites', 'atualizarBlocoAuxilio', 'atualizarQuantidadeAuxilio',
         ...
         'verificarPessoasDias', 'sincronizarCalculadoRestaurado',
         'carregarShortcutRestaurado'].forEach(function (fn) {
...
def contadores_menu():
    ...
    eh_executor = current_user.perfil in ('comprador', 'analista') or current_user.is_organizador
    ...
    if eh_executor or tem_demandas_atribuidas():
        ...
        # comprador e analista veem o total (mesma regra da listagem em si -
        # acompanhamento de equipe, nao so o que foi atribuido a cada um)
        if not current_user.is_organizador and current_user.perfil not in ('comprador', 'analista'):
    ...
    if eh_analista or eh_aprovador or eh_executor:
        ...
        dados['prestacao'] = db.session.query(SolicitacaoDiaria).join(
            Solicitacao, SolicitacaoDiaria.solicitacao_id == Solicitacao.id
        ).filter(
            Solicitacao.tipo == 'diaria',
            Solicitacao.status.in_(('aprovada', 'em_execucao', 'enviado_pagamento', 'paga')),
            SolicitacaoDiaria.prestacao_contas_entregue.isnot(True),
            SolicitacaoDiaria.relatorio_em_conferencia.isnot(True),
    ...
    # prestações de contas do próprio solicitante ainda em aberto (por
    # diarista - se a pessoa solicitou diária para várias pessoas, cada
    # relatório pendente conta separado)
    dados['minhas_prestacoes'] = db.session.query(SolicitacaoDiaria).join(
        Solicitacao, SolicitacaoDiaria.solicitacao_id == Solicitacao.id
    ).filter(
        Solicitacao.solicitante_id == current_user.id,
        Solicitacao.tipo == 'diaria',
...
# ---------------- LAYOUT BASE ----------------
BASE_TEMPLATE = """
<!-- VERSAO-SIGAD-CARAJAS: 2026-08-31-COMPRA-33-ITENS-01 -->
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        :root {
            ...
            /* aviso laranja (itens/solicitações que exigem orçamento) */
            --aviso-fundo: #fff8e6;
            --aviso-borda: #b35c00;
            --aviso-texto: #7a4a00;
        }
        * { box-sizing: border-box; }
        ...
        @media (prefers-color-scheme: dark) {
            :root {
                ...
                /* aviso laranja - recalibrado pra ficar legivel em fundo escuro */
                --aviso-fundo: #3a2e14;
                --aviso-borda: #d68a2e;
                --aviso-texto: #f5c98a;
            }
        ...
        /* aviso de item/solicitação que exige orçamento - usa variaveis, não
           cor fixa em linha, porque JS troca o display desses blocos e o
           navegador reescreve o atributo style ao fazer isso (de
           "background:#fff8e6" para "background: rgb(255, 248, 230)"),
           quebrando qualquer seletor CSS que dependa do texto exato do
           style em linha para o modo escuro funcionar */
        .aviso-orcamento {
            background: var(--aviso-fundo); border-left: 3px solid var(--aviso-borda);
            color: var(--aviso-texto); border-radius: 4px;
        }
        .aviso-orcamento strong { color: var(--aviso-borda); }
...
<body>
    <nav>
        ...
        {% if current_user.perfil in ('comprador', 'analista') or current_user.is_organizador or tem_demandas_atribuidas() %}
    ...
    // Integração com o Shortcut - funções globais, usadas em qualquer
    // formulário de solicitação que tenha os campos de Objetivo/Épico.
    // Ficam aqui (script compartilhado por toda página) em vez de
    // duplicadas em cada formulário individualmente.
    function carregarObjetivosShortcut(coordenacaoId, manterEpico) {
        var campo = document.getElementById('shortcut_objetivo_id');
        if (!campo) return;

        // trocar a coordenação invalida o objetivo (e, por tabela, o
        // épico) já escolhidos - zera os dois campos, a não ser que seja
        // a restauração de uma correção (que já tem os valores certos
        // salvos e só precisa recarregar as opções, sem perder o que
        // estava selecionado)
        if (!manterEpico) {
            var campoEpico = document.getElementById('shortcut_epico_id');
            var campoEpicoNome = document.getElementById('shortcut_epico_nome');
            if (campoEpico) { campoEpico.innerHTML = '<option value="">Selecione o objetivo primeiro</option>'; }
            if (campoEpicoNome) { campoEpicoNome.value = ''; }
        }

        if (!coordenacaoId) {
            campo.innerHTML = '<option value="">Selecione a coordenação primeiro</option>';
            return;
        }

        // guarda o nome que estava salvo (campo oculto, restaura certinho
        // mesmo antes da lista carregar) - usado pra re-selecionar depois
        // que as opções reais chegarem, já que um <select> não guarda um
        // valor que ainda não existe como opção
        var campoNome = document.getElementById('shortcut_objetivo_nome');
        var nomeSalvo = campoNome ? campoNome.value : '';

        campo.innerHTML = '<option value="">Carregando...</option>';
        fetch('/api/shortcut-objetivos?coordenacao_id=' + encodeURIComponent(coordenacaoId))
            .then(function(resposta) { return resposta.json(); })
            .then(function(objetivos) {
                if (!objetivos || objetivos.length === 0) {
                    campo.innerHTML = '<option value="">Nenhum objetivo encontrado para essa coordenação</option>';
                    return;
                }
                var html = '<option value="">Nenhum</option>';
                var idParaSelecionar = '';
                objetivos.forEach(function(obj) {
                    html += '<option value="' + obj.id + '" data-nome="' + obj.name.replace(/"/g, '&quot;') + '">' + obj.name + '</option>';
                    if (nomeSalvo && obj.name === nomeSalvo) { idParaSelecionar = obj.id; }
                });
                campo.innerHTML = html;
                if (idParaSelecionar) { campo.value = idParaSelecionar; }
            })
            .catch(function() {
                campo.innerHTML = '<option value="">Não foi possível carregar</option>';
            });
    }

    function carregarEpicosShortcut(objetivoId) {
        var campo = document.getElementById('shortcut_epico_id');
        if (!campo) return;

        if (!objetivoId) {
            campo.innerHTML = '<option value="">Selecione o objetivo primeiro</option>';
            // sem objetivo selecionado, nao ha epico valido - limpa tambem
            // o nome guardado, senao o formulario poderia enviar um nome
            // de epico "orfao" (sem o id correspondente)
            var campoNomeVazio = document.getElementById('shortcut_epico_nome');
            if (campoNomeVazio) { campoNomeVazio.value = ''; }
            return;
        }

        var campoNome = document.getElementById('shortcut_epico_nome');
        var nomeSalvo = campoNome ? campoNome.value : '';

        campo.innerHTML = '<option value="">Carregando...</option>';
        fetch('/api/shortcut-epicos?objetivo_id=' + encodeURIComponent(objetivoId))
            .then(function(resposta) { return resposta.json(); })
            .then(function(epicos) {
                if (!epicos || epicos.length === 0) {
                    campo.innerHTML = '<option value="">Nenhum épico encontrado para esse objetivo</option>';
                    return;
                }
                var html = '<option value="">Nenhum</option>';
                var idParaSelecionar = '';
                epicos.forEach(function(ep) {
                    html += '<option value="' + ep.id + '" data-nome="' + ep.name.replace(/"/g, '&quot;') + '">' + ep.name + '</option>';
                    if (nomeSalvo && ep.name === nomeSalvo) { idParaSelecionar = ep.id; }
                });
                campo.innerHTML = html;
                if (idParaSelecionar) { campo.value = idParaSelecionar; }
            })
    ...
    // ao abrir a página, se os campos já vierem preenchidos (caso de
    // correção de solicitação devolvida), carrega a cadeia automaticamente.
    // Essa checagem sozinha só cobre a abertura simples da página - a
    // restauração de uma correção acontece depois, então também é chamada
    // por "carregarShortcutRestaurado" na lista de recálculos pós-restauração.
    function carregarShortcutRestaurado() {
        var campoCoordenacao = document.getElementById('coordenacao_solicitante');
        if (campoCoordenacao && campoCoordenacao.value) {
            // manterEpico=true: aqui é restauração de uma correção, o
            // nome do épico já salvo tem que sobreviver pra ser
            // reencontrado no carregarEpicosShortcut logo abaixo
            carregarObjetivosShortcut(campoCoordenacao.value, true);
        }
        var campoObjetivo = document.getElementById('shortcut_objetivo_id');
        if (campoObjetivo && campoObjetivo.value) {
            carregarEpicosShortcut(campoObjetivo.value);
        }
    }
    carregarShortcutRestaurado();
    </script>
</body>
</html>
"""
...
def inicio():
    ...
    if pode_ver_prestacao():
        from datetime import timedelta
        limite = hoje() - timedelta(days=PRAZO_PRESTACAO_DIAS)
        qtd_prestacao = db.session.query(SolicitacaoDiaria).join(
            Solicitacao, SolicitacaoDiaria.solicitacao_id == Solicitacao.id
        ).filter(
            Solicitacao.tipo == 'diaria',
            Solicitacao.status.in_(('aprovada', 'em_execucao', 'enviado_pagamento', 'paga')),
    ...
    if pode_avaliar_prestacao():
        qtd_conferencia = db.session.query(SolicitacaoDiaria).join(
            Solicitacao, SolicitacaoDiaria.solicitacao_id == Solicitacao.id
        ).filter(
            Solicitacao.tipo == 'diaria',
            SolicitacaoDiaria.relatorio_em_conferencia.is_(True),
        ).count()
        cartoes += cartao_pendencia(
    ...
    minhas_pendentes_relatorio = db.session.query(SolicitacaoDiaria).join(
        Solicitacao, SolicitacaoDiaria.solicitacao_id == Solicitacao.id
    ).filter(
        Solicitacao.solicitante_id == current_user.id,
        Solicitacao.tipo == 'diaria',
...
def minhas_solicitacoes():
    ...
    # (uma LISTA por solicitação, porque pode ter mais de um diarista)
    ...
    if ids_pagina:
        for registro in SolicitacaoDiaria.query.filter(
            ...
            diarias_por_solicitacao.setdefault(registro.solicitacao_id, []).append(registro)
    ...
    for s in solicitacoes:
        ...
        # a linha inteira fica vermelha quando ALGUM diarista ainda está
        # com a prestação de contas pendente (podem ser vários na mesma
        # solicitação, cada um com sua própria situação)
        diaristas_da_linha = diarias_por_solicitacao.get(s.id, [])
        prestacao_pendente = (
            s.tipo == 'diaria'
            and s.status in ('aprovada', 'em_execucao', 'enviado_pagamento', 'paga')
            and any(not d.prestacao_contas_entregue for d in diaristas_da_linha)
        )
        ...
        if prestacao_pendente:
            # só entre quem ainda está pendente - se for so 1 diarista (o
            # caso comum), a mensagem fica igual a antes; se forem vários,
            # mostra o nome de cada um que falta
            pendentes_da_linha = [d for d in diaristas_da_linha if not d.prestacao_contas_entregue]
            if pendentes_da_linha:
                prazo_pc = pendentes_da_linha[0].data_retorno + timedelta(days=PRAZO_PRESTACAO_DIAS)
                atrasada = hoje() > prazo_pc
                nomes_pendentes = ', '.join(d.nome_diarista for d in pendentes_da_linha)
                prefixo_nome = f'[{nomes_pendentes}] ' if len(diaristas_da_linha) > 1 else ''

                if all(d.relatorio_em_conferencia for d in pendentes_da_linha):
                    aviso_pc = f'{prefixo_nome}Relatório enviado — aguardando conferência.'
                elif any(d.motivo_recusa_prestacao for d in pendentes_da_linha):
                    aviso_pc = f'{prefixo_nome}RELATÓRIO DEVOLVIDO — corrija e reenvie.'
                elif atrasada:
                    dias = (hoje() - prazo_pc).days
                    aviso_pc = f'{prefixo_nome}PRESTAÇÃO DE CONTAS EM ATRASO ({dias} dia(s)) — prazo era {prazo_pc.strftime("%d/%m/%Y")}.'
                else:
                    aviso_pc = f'{prefixo_nome}Prestação de contas pendente — envie o relatório até {prazo_pc.strftime("%d/%m/%Y")}.'
...
def acao_analise(solicitacao_id):
    ...
    if acao == 'enviar':
        ...
        if notificar_aprovador_por_email():
...
def valor_diaria_individual(d):
    """Valor total desta diária específica (a diária em si + o auxílio),
    considerando o modo detalhado (cheia/meia) ou o simples."""
    if d.diaria_detalhada:
        base = ((d.qtd_diarias_cheias or 0) * float(d.valor_unitario_cheia or 0)
                + (d.qtd_diarias_meias or 0) * float(d.valor_unitario_meia or 0))
    else:
        pernoites = d.numero_pernoites or 0
        qtd = pernoites if pernoites > 0 else 1
        base = float(d.valor_diaria or 0) * qtd
    return base + float(d.valor_auxilio or 0)


# mapeia cada tipo multi-item para: (modelo do item, nome do campo de valor
# do item - None quando o tipo não tem valor por item, como Seguro; nome do
# campo usado como "nome" do item, para aparecer no resumo se tudo for
# reprovado)
MODELO_ITEM_POR_TIPO = {
    'compra_materiais': (SolicitacaoCompraMateriais, 'valor_total_item', 'nome_especificacao'),
    'rancho': (ItemSolicitacaoRancho, 'valor_total_item', 'nome_item'),
    'passagem': (SolicitacaoPassagem, 'valor_estimado', 'nome_passageiro'),
    'diaria': (SolicitacaoDiaria, None, 'nome_diarista'),
    'servico_externo_pf': (PrestadorServico, 'valor_servico', 'nome_prestador'),
    'seguro': (ParticipanteSeguro, None, 'nome_completo'),
    'bolsa': (BolsistaSolicitacao, 'valor_total_bolsa', 'nome_bolsista'),
}


def processar_itens_aprovacao(solicitacao):
    """Lê quais itens o Aprovador marcou para reprovar (checkbox
    'itens_reprovados[]' com o id de cada item, e um campo
    'motivo_item_<id>' com a justificativa de cada um). Marca esses itens
    como reprovados, recalcula o valor total considerando só os itens que
    continuam aprovados, e devolve (todos_reprovados, resumo) - quando
    todos_reprovados é True, quem chamou deve tratar como reprovação da
    solicitação inteira, não aprovação parcial."""
    config = MODELO_ITEM_POR_TIPO.get(solicitacao.tipo)
    if not config:
        return False, ''  # tipo de item único - nada a fazer aqui

    modelo, campo_valor, campo_nome = config
    itens = modelo.query.filter_by(solicitacao_id=solicitacao.id).all()
    if not itens:
        return False, ''

    ids_reprovados = set(request.form.getlist('itens_reprovados[]'))

    valor_total_recalculado = 0
    for item in itens:
        if str(item.id) in ids_reprovados:
            motivo_item = (request.form.get(f'motivo_item_{item.id}') or '').strip()
            item.status_aprovacao_item = 'reprovado'
            item.motivo_reprovacao_item = motivo_item or 'Sem justificativa informada.'
        else:
            item.status_aprovacao_item = 'aprovado'
            item.motivo_reprovacao_item = None

            if solicitacao.tipo == 'diaria':
                valor_total_recalculado += valor_diaria_individual(item)
            elif campo_valor:
                valor_total_recalculado += float(getattr(item, campo_valor) or 0)

    if campo_valor or solicitacao.tipo == 'diaria':
        solicitacao.valor_total = valor_total_recalculado

    todos_reprovados = all(str(item.id) in ids_reprovados for item in itens)
    resumo = '; '.join(
        f'{getattr(item, campo_nome, "item")}: {item.motivo_reprovacao_item}' for item in itens
    ) if todos_reprovados else ''

    return todos_reprovados, resumo


def pode_decidir_itens_agora(solicitacao):
    """True quando o usuário atual está na etapa certa para reprovar item a
    item AGORA (Analista na triagem, ou Aprovador na aprovação)."""
    if solicitacao.status == 'pendente_analise':
        return current_user.perfil == 'analista' or current_user.is_organizador
    if solicitacao.status == 'pendente_aprovacao':
        return current_user.perfil == 'aprovador' or current_user.is_organizador
    return False


def celula_orcamentos_item(item, solicitacao, valor_do_item, campo_ligacao, rota_upload, nome_para_mensagem):
    """Monta a celula/bloco de exigencia de 3 orcamentos para UM item ou
    prestador especifico, quando ele sozinho ultrapassa
    VALOR_MINIMO_EXIGE_ORCAMENTOS - mostra quantos ja foram anexados e um
    botao de enviar mais, direto ao lado do item na tabela."""
    if float(valor_do_item or 0) <= VALOR_MINIMO_EXIGE_ORCAMENTOS:
        return ""

    anexos_deste_item = Anexo.query.filter_by(
        tipo_anexo="orcamento", **{campo_ligacao: item.id}
    ).all()
    qtd = len(anexos_deste_item)
    cor = "#2e7d32" if qtd >= 3 else "#c0392b"
    situacao = "requisito atendido" if qtd >= 3 else f"faltam {3 - qtd}"
    ...
    lista_arquivos = ""
    if anexos_deste_item:
        itens_lista = "".join(
            f'<li style="font-size:10.5px;">{a.nome_arquivo}</li>' for a in anexos_deste_item
        )
        lista_arquivos = f'<ul style="margin:4px 0; padding-left:16px;">{itens_lista}</ul>'

    form_upload = ""
    if pode_anexar and qtd < 3:
        form_upload = (
            f'<form method="POST" action="{rota_upload}" enctype="multipart/form-data" style="margin-top:4px;">'
            f'<input type="file" name="orcamentos" multiple accept=".pdf,.jpg,.jpeg,.png" style="font-size:10.5px; width:100%;">'
            f'<button type="submit" style="font-size:10.5px; padding:3px 8px; margin-top:3px;">Anexar</button>'
            f'</form>'
        )

    return (
        f'<div class="aviso-orcamento" style="border-left:3px solid {cor}; padding:6px 8px; font-size:11px;">'
        f'<strong style="color:{cor};">\u26a0 Item acima de {moeda(VALOR_MINIMO_EXIGE_ORCAMENTOS)} - exige 3 orcamentos</strong><br>'
        f'{qtd}/3 anexados - <span style="color:{cor};">{situacao}</span>'
        f'{lista_arquivos}'
        f'{form_upload}'
        f'</div>'
    )
...
def celula_reprovar_item(item, solicitacao):
    """Célula de ação para uma linha de item, pensada para entrar direto na
    tabela de itens (perto de onde a pessoa já está olhando os detalhes),
    mesmo a tabela ficando fisicamente fora do <form> de decisão - o
    atributo form="form-decisao" faz o checkbox e o texto contarem como
    parte daquele formulário de qualquer forma."""
    if item.status_aprovacao_item == 'reprovado':
        motivo_escapado = (item.motivo_reprovacao_item or '').replace('"', '&quot;')
        if pode_decidir_itens_agora(solicitacao):
            return f"""
            <span style="color:#c0392b; font-size:11px; font-weight:bold;" title="{motivo_escapado}">
                ✕ Reprovado
            </span><br>
            <label style="font-size:11px; font-weight:normal;">
                <input type="checkbox" name="itens_reprovados[]" value="{item.id}"
                       class="checkbox-reprovar-item" data-item-id="{item.id}" checked
                       form="form-decisao">
                manter reprovado
            </label>
            <div id="motivo-item-{item.id}" style="margin-top:4px;">
                <textarea name="motivo_item_{item.id}" form="form-decisao" rows="2"
                          style="width:100%; padding:4px; font-size:11px;">{item.motivo_reprovacao_item or ''}</textarea>
            </div>
            """
        return f'<span style="color:#c0392b; font-size:11px; font-weight:bold;" title="{motivo_escapado}">✕ Reprovado</span>'

    if not pode_decidir_itens_agora(solicitacao):
        return ''

    return f"""
    <label style="font-size:11px;">
        <input type="checkbox" name="itens_reprovados[]" value="{item.id}"
               class="checkbox-reprovar-item" data-item-id="{item.id}" form="form-decisao">
        Reprovar
    </label>
    <div id="motivo-item-{item.id}" style="display:none; margin-top:4px;">
        <textarea name="motivo_item_{item.id}" form="form-decisao" placeholder="Motivo"
                  rows="2" style="width:100%; padding:4px; font-size:11px;"></textarea>
    </div>
    """
...
def acao_aprovacao(solicitacao_id):
    ...
    if acao == 'aprovar':
        ...
        if todos_reprovados:
            # todos os itens foram reprovados individualmente - equivale a
            # reprovar a solicitação inteira, mesmo fluxo de sempre
            solicitacao.status = 'reprovada'
            solicitacao.motivo_reprovacao = resumo_reprovacoes or 'Todos os itens foram reprovados.'
            solicitacao.reprovada_por = f'{current_user.nome} (Aprovador)'
            registrar_auditoria('reprovou_aprovacao', solicitacao, solicitacao.motivo_reprovacao)
            db.session.commit()
            ...
            notificar_solicitante(
                ...
                f'Olá, {solicitacao.solicitante.nome}.\n\n'
                f'Sua solicitação de {tipo_label}, protocolo {protocolo(solicitacao)}, foi reprovada '
                f'na etapa de aprovação - todos os itens foram individualmente reprovados.\n\n'
                f'Detalhes: {solicitacao.motivo_reprovacao}\n\n'
        ...
        config_item = MODELO_ITEM_POR_TIPO.get(solicitacao.tipo)
        if config_item:
            modelo_item, _campo_valor, campo_nome = config_item
            itens_reprovados_parcial = modelo_item.query.filter_by(
                solicitacao_id=solicitacao.id, status_aprovacao_item='reprovado').all()
            if itens_reprovados_parcial:
                lista_reprovados = '\n'.join(
                    f'- {getattr(it, campo_nome, "Item")}: {it.motivo_reprovacao_item}'
                    for it in itens_reprovados_parcial
                )
                corpo_aprovacao += (
                    f'\n\nATENÇÃO: os itens abaixo NÃO foram aprovados e não serão executados:\n'
                    f'{lista_reprovados}'
                )
...
@login_required
def fila_execucao():
    eh_comprador = current_user.perfil in ('comprador', 'analista') or current_user.is_organizador
    ...
    # atribuidas a ele - permite cobertura de equipe entre colegas. O
    # Analista tambem ve tudo, ja que os Executores respondem pra ele -
    # acompanhamento e supervisao do andamento das execucoes
    if not current_user.is_organizador and current_user.perfil not in ('comprador', 'analista'):
        consulta = consulta.filter(Solicitacao.responsavel_encaminhamento_id == current_user.id)
    ...
    # filtro por nome do executor/responsavel - so faz sentido pra quem
    # ja enxerga a fila inteira (Executor/Analista/Admin); pra quem so ve
    # as proprias demandas, filtrar por "responsavel" nao ajudaria em nada
    filtro_executor_id = request.args.get('executor_id', '').strip()
    if filtro_executor_id:
        consulta = consulta.filter(Solicitacao.responsavel_encaminhamento_id == filtro_executor_id)

    lista_executores = []
    if eh_comprador:
        lista_executores = Usuario.query.filter_by(perfil='comprador').order_by(Usuario.nome).all()

    # com Executor e Analista vendo tudo, a lista cresceu bastante - por
    # padrao mostra so o que ainda precisa de atencao, escondendo o que ja
    # foi concluido (mas sem esconder de vez, um clique mostra tudo)
    status_filtro = request.args.get('status_filtro', 'pendentes')
    consulta_contagem = consulta  # antes do filtro de status, pra contar os totais de cada grupo
    qtd_pendentes = consulta_contagem.filter(Solicitacao.status.in_(STATUS_EM_ANDAMENTO)).count()
    qtd_concluidas = consulta_contagem.filter(Solicitacao.status.in_(STATUS_CONCLUIDOS)).count()

    if status_filtro == 'pendentes':
        consulta = consulta.filter(Solicitacao.status.in_(STATUS_EM_ANDAMENTO))
    elif status_filtro == 'concluidas':
        consulta = consulta.filter(Solicitacao.status.in_(STATUS_CONCLUIDOS))
    # 'todas' nao filtra mais nada, mantem os dois grupos
    ...
    for s in solicitacoes:
        ...
        fundo_selo = {
            '#2b5876': '#eaf1f6', '#b35c00': '#fff3e6',
            '#6a4fa0': '#f2eefa', '#2e7d32': '#eaf5ec',
        }.get(cor, '#f0f0f0')
        selo_status = (f'<span style="background:{fundo_selo}; color:{cor}; font-weight:bold; '
                       f'font-size:11.5px; padding:3px 10px; border-radius:12px; white-space:nowrap; '
        ...
        <tr>
            ...
            <td>{responsavel}</td>
            <td>{prazo}</td>
            <td>{selo_status}{alerta_boleto}</td>
            <td>
                {moeda(s.valor_total)}
    ...
    def aba_filtro(valor, rotulo, contagem=None):
        ativa = status_filtro == valor
        contagem_html = f' ({contagem})' if contagem is not None else ''
        estilo = ('background:#37784D; color:#fff;' if ativa
                  else 'background:#eef2ef; color:#37784D;')
        return (f'<a href="{url_for("fila_execucao", status_filtro=valor, protocolo=filtro_protocolo or None)}" '
                f'style="text-decoration:none; padding:8px 16px; border-radius:6px; font-size:13px; '
                f'font-weight:bold; {estilo}">{rotulo}{contagem_html}</a>')
    ...
    <div style="display:flex; gap:8px; margin-bottom:16px; flex-wrap:wrap;">
        {aba_filtro('pendentes', 'Pendentes de ação', qtd_pendentes)}
        {aba_filtro('concluidas', 'Concluídas', qtd_concluidas)}
        {aba_filtro('todas', 'Todas')}
    </div>
    ...
    <form method="GET" style="margin-bottom:14px; display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
        ...
        {f'<select name="executor_id" style="padding:7px;"><option value="">Todos os executores</option>' + "".join(f'<option value="{ex.id}" {"selected" if str(ex.id) == filtro_executor_id else ""}>{ex.nome}</option>' for ex in lista_executores) + '</select>' if lista_executores else ''}
        <button type="submit" class="btn-atalho">Filtrar</button>
        {f'<a href="{url_for("fila_execucao", status_filtro=status_filtro)}" class="btn-atalho">Limpar</a>' if (filtro_protocolo or filtro_executor_id) else ''}
    </form>
...
def pode_executar(solicitacao):
    ...
    # cuida daquela demanda). O Analista tambem pode agir - os Executores
    # respondem pra ele, entao ele acompanha e pode atualizar se precisar
    return current_user.is_organizador or current_user.perfil in ('comprador', 'analista')
...
def acao_execucao(solicitacao_id):
    ...
    if acao == 'marcar_comprado':
        ...
        if solicitacao.tipo == 'compra_materiais':
            itens_sem_orcamento = []
            for item in SolicitacaoCompraMateriais.query.filter_by(solicitacao_id=solicitacao.id).all():
                if float(item.valor_total_item or 0) > VALOR_MINIMO_EXIGE_ORCAMENTOS:
                    qtd = Anexo.query.filter_by(item_compra_id=item.id, tipo_anexo='orcamento').count()
                    if qtd < 3:
                        itens_sem_orcamento.append(f'{item.nome_especificacao} ({qtd}/3)')

            if itens_sem_orcamento:
                flash('Não é possível concluir: os itens abaixo passam de '
                      f'{moeda(VALOR_MINIMO_EXIGE_ORCAMENTOS)} e ainda não têm os 3 orçamentos '
                      f'anexados: {"; ".join(itens_sem_orcamento)}.')
                return redirect(url_for('detalhe_solicitacao', solicitacao_id=solicitacao_id))
    ...
    if acao == 'marcar_nf_pago':
        ...
        prestadores_sem_orcamento = []
        for prestador in PrestadorServico.query.filter_by(solicitacao_id=solicitacao.id).all():
            if float(prestador.valor_servico or 0) > VALOR_MINIMO_EXIGE_ORCAMENTOS:
                qtd = Anexo.query.filter_by(prestador_id=prestador.id, tipo_anexo='orcamento').count()
                if qtd < 3:
                    prestadores_sem_orcamento.append(f'{prestador.nome_prestador} ({qtd}/3)')

        if prestadores_sem_orcamento:
            flash('Não é possível concluir: os prestadores abaixo passam de '
                  f'{moeda(VALOR_MINIMO_EXIGE_ORCAMENTOS)} e ainda não têm os 3 orçamentos '
                  f'anexados: {"; ".join(prestadores_sem_orcamento)}.')
            return redirect(url_for('detalhe_solicitacao', solicitacao_id=solicitacao_id))
    ...
    if acao == 'marcar_paga':
        # PJ (empresa) tambem entra na regra dos 3 orcamentos quando o
        # valor do prestador passa de R$5.000 - a PF ja tem essa trava na
        # acao 'marcar_nf_pago' (fluxo de boleto/NF); aqui cobre o PJ, que
        # usa esta acao generica de "marcar como paga" direto
        if solicitacao.tipo == 'servico_externo_pj':
            prestadores_sem_orcamento = []
            for prestador in PrestadorServico.query.filter_by(solicitacao_id=solicitacao.id).all():
                if float(prestador.valor_servico or 0) > VALOR_MINIMO_EXIGE_ORCAMENTOS:
                    qtd = Anexo.query.filter_by(prestador_id=prestador.id, tipo_anexo='orcamento').count()
...
# ---------------- API: objetivos do Shortcut ----------------
@app.route('/api/shortcut-objetivos')
@login_required
def api_shortcut_objetivos():
    coordenacao_id = request.args.get('coordenacao_id')
    filtro_nome = None
    nomes_ignorados = []
    if coordenacao_id:
        coordenacao = Coordenacao.query.get(coordenacao_id)
        if coordenacao and coordenacao.nome_shortcut:
            filtro_nome = coordenacao.nome_shortcut
        if coordenacao and coordenacao.shortcut_objetivos_ignorados:
            nomes_ignorados = coordenacao.shortcut_objetivos_ignorados.splitlines()
    return jsonify(listar_objetivos_shortcut(filtro_nome, nomes_ignorados))


# ---------------- API: épicos do Shortcut ----------------
@app.route('/api/shortcut-epicos')
@login_required
def api_shortcut_epicos():
    objetivo_id = request.args.get('objetivo_id')
    return jsonify(listar_epicos_shortcut(objetivo_id))
...
<form method="POST" enctype="multipart/form-data" style="max-width: 600px;" id="form-diaria">
    ...
    <select name="coordenacao_solicitante" id="coordenacao_solicitante" required style="padding:6px; margin-bottom:10px;"
            onchange="carregarObjetivosShortcut(this.value);">
        <option value="">Selecione</option>
        __OPCOES_COORDENACAO__
    </select><br>

    __BLOCO_SHORTCUT_OBJETIVO_EPICO__
    ...
    <div style="font-size:11.5px; color:#888; margin-bottom:10px;">
        Preencha esta seção só se a solicitação incluir diária. Se for só Auxílio Deslocamento,
        pode deixar em branco e preencher apenas a seção de auxílio, mais abaixo.
    </div>
    <label>Data de ida:</label><br>
    <input type="date" name="data_ida" id="data_ida" style="padding:6px; margin-bottom:10px;"><br>

    <label>Data de retorno:</label><br>
    <input type="date" name="data_retorno" id="data_retorno" style="padding:6px; margin-bottom:10px;"><br>

    <label>Local de origem:</label><br>
    <div style="display:flex; gap:10px; margin-bottom:10px;">
        <input type="text" name="cidade_origem" placeholder="Cidade" style="flex:1; padding:6px;">
        <select name="estado_origem" style="padding:6px; width:90px;">
    ...
    <div style="display:flex; gap:10px; margin-bottom:10px;">
        <input type="text" name="cidade_destino" placeholder="Cidade" style="flex:1; padding:6px;">
        <select name="estado_destino" style="padding:6px; width:90px;">
            <option value="">UF</option>
            __OPCOES_ESTADOS__
        </select>
    </div>

    <label>Tipo de diária:</label><br>
    <select name="tipo_destino" id="tipo_destino" style="padding:6px; margin-bottom:10px;">
        __OPCOES_AREAS__
    </select><br>
    ...
    <div id="bloco_tipo_diaria_simples">
        <label>Diária Cheia ou Meia? (deixe em "Nenhuma" se a solicitação for só de Auxílio Deslocamento)</label><br>
        <select name="tipo_diaria" id="tipo_diaria" style="padding:6px; margin-bottom:10px;">
            <option value="">Nenhuma / só Auxílio Deslocamento</option>
            __OPCOES_DIARIA__
        </select><br>
    </div>
    ...
    <div style="font-size:11px; color:#888; margin-bottom:4px;">
        Explique o motivo da diária e/ou do Auxílio Deslocamento, conforme o caso.
    </div>
    ...
    <div class="bloco" style="background:#eef4f8; border-left:4px solid #2b5876; max-width:750px; margin-bottom:14px;">
        <strong style="font-size:12.5px; color:#2b5876;">Aviso de privacidade</strong>
        <div style="font-size:11.5px; color:#555; margin-top:4px;">
            Os dados pessoais informados abaixo (nome, CPF, telefone, e-mail e dados bancários) são
            coletados exclusivamente para viabilizar o pagamento desta diária, incluindo o
            compartilhamento com a instituição bancária responsável pelo depósito. Os dados ficam
            armazenados enquanto a solicitação estiver ativa e pelo prazo necessário ao cumprimento
            de obrigações legais e de prestação de contas.
        </div>
    </div>
...
def bloco_shortcut_objetivo_epico():
    """HTML dos campos de Objetivo/Épico do Shortcut - centralizado aqui
    pra ser inserido (ou não, se a integração estiver pausada) em todos os
    10 formulários de solicitação a partir do marcador
    __BLOCO_SHORTCUT_OBJETIVO_EPICO__."""
    if not shortcut_integracao_ativa():
        return ''
    return '''    <label>Objetivo vinculado (Shortcut):</label><br>
    <select name="shortcut_objetivo_id" id="shortcut_objetivo_id" style="padding:6px; margin-bottom:4px; width:100%; max-width:400px;"
            onchange="
                document.getElementById('shortcut_objetivo_nome').value = this.options[this.selectedIndex].getAttribute('data-nome') || '';
                carregarEpicosShortcut(this.value);
            ">
        <option value="">Selecione a coordenação primeiro</option>
    </select>
    <input type="hidden" name="shortcut_objetivo_nome" id="shortcut_objetivo_nome"><br>
    <div style="font-size:11px; color:#888; margin-bottom:10px;">
        Opcional. Essa lista é preenchida automaticamente com os objetivos do Shortcut vinculados
        à coordenação escolhida acima — não precisa cadastrar nada manualmente aqui.
    </div>

    <label>Épico vinculado (Shortcut):</label><br>
    <select name="shortcut_epico_id" id="shortcut_epico_id" style="padding:6px; margin-bottom:4px; width:100%; max-width:400px;"
            onchange="document.getElementById('shortcut_epico_nome').value = this.options[this.selectedIndex].getAttribute('data-nome') || '';">
        <option value="">Selecione o objetivo primeiro</option>
    </select>
    <input type="hidden" name="shortcut_epico_nome" id="shortcut_epico_nome"><br>
    <div style="font-size:11px; color:#888; margin-bottom:10px;">
        Opcional. Preenchida automaticamente com os épicos vinculados ao objetivo escolhido acima.
    </div>
'''
...
def montar_formulario_diaria():
    ...
    html = html.replace('__BLOCO_SHORTCUT_OBJETIVO_EPICO__', bloco_shortcut_objetivo_epico())
    return html
...
def diaria_form():
    ...
    if request.method == 'POST':
        ...
        # detecta se a pessoa de fato preencheu dados de diaria, ou deixou
        # em branco de proposito porque a solicitacao e so de Auxilio
        # Deslocamento (ex: precisa so do valor pra ir ate a rodoviaria,
        # sem diaria nenhuma) - sem precisar de nenhum botao/opcao extra,
        # o proprio preenchimento (ou nao) dos campos de diaria já indica isso
        if diaria_detalhada:
            preencheu_diaria = bool(request.form.get('data_ida')) or bool(request.form.get('data_retorno'))
        else:
            preencheu_diaria = bool(request.form.get('tipo_diaria'))

        so_auxilio = tera_auxilio and not preencheu_diaria

        if not preencheu_diaria and not tera_auxilio:
            flash('Informe os dados da diária, ou marque "Auxílio Deslocamento" se a '
                  'solicitação for só do auxílio, sem diária.')
            return render_pagina('Solicitação de Diária',
                                 preservar_preenchimento(montar_formulario_diaria(), request.form))

        if so_auxilio:
            # pula toda a validacao e o calculo de diaria - fica tudo zerado,
            # a solicitacao e composta so pelo auxilio deslocamento
            tipo_diaria = None
            valor_diaria = 0
        ...
        solicitacao, era_correcao = obter_solicitacao_para_gravar(
            ...
            shortcut_objetivo_id=(request.form.get('shortcut_objetivo_id') or None),
            shortcut_objetivo_nome=(request.form.get('shortcut_objetivo_nome') or None),
            shortcut_epico_id=(request.form.get('shortcut_epico_id') or None),
            shortcut_epico_nome=(request.form.get('shortcut_epico_nome') or None),
        )
        if era_correcao:
...
<form method="POST" style="max-width: 760px;" id="form-passagem">
    ...
    <div class="bloco" style="background:#eef4f8; border-left:4px solid #2b5876; max-width:750px; margin-bottom:14px;">
        <strong style="font-size:12.5px; color:#2b5876;">Aviso de privacidade</strong>
        <div style="font-size:11.5px; color:#555; margin-top:4px;">
            Os dados pessoais informados abaixo (nome, CPF, RG, data de nascimento, telefone e
            e-mail) são coletados exclusivamente para viabilizar a emissão da passagem, incluindo o
            compartilhamento com a companhia aérea ou agência responsável pela compra. Os dados
            ficam armazenados enquanto a solicitação estiver ativa e pelo prazo necessário ao
            cumprimento de obrigações legais e de prestação de contas.
        </div>
    </div>
...
<form method="POST" enctype="multipart/form-data" style="max-width: 800px;" id="form-compra-materiais">
    ...
    <div id="aviso_cotacoes" class="aviso-orcamento" style="display:none;
         padding:12px 15px; font-size:12.5px; margin:14px 0;">
        <strong>Atenção:</strong> <span id="lista_itens_caros"></span>
        <br>Anexe <strong>até 3 orçamentos</strong> em cada um desses itens, no campo que apareceu
        logo abaixo da justificativa dele. Se preferir, também pode enviar a solicitação sem
        anexar agora e completar depois, na tela de detalhe - mas o Executor não conseguirá
        concluir a compra sem os orçamentos de cada item.
    </div>

    <label>Anexos gerais (catálogos, especificações - opcional):</label><br>
...
function htmlDoItem(numero) {
    ...
    '<div class="bloco-item bloco" style="margin-bottom:15px;">' +
        ...
        '<div class="bloco-orcamento-item aviso-orcamento" style="display:none; margin-top:8px; padding:8px 10px;">' +
            '<label style="font-size:12px;"><strong>Este item passa de R$5.000 - anexe até 3 orçamentos:</strong></label>' +
            '<div class="lista-campos-orcamento"></div>' +
            '<button type="button" class="btn-adicionar-orcamento" style="font-size:11px; padding:4px 10px; margin-top:4px;">+ Adicionar orçamento</button>' +
            '<div class="texto-arquivos-selecionados" style="font-size:11px; margin-top:5px;"></div>' +
        '</div>' +
    '</div>';
}
...
function calcularTotalCompra() {
    ...
    document.querySelectorAll('.bloco-item').forEach(function(bloco, indice) {
        ...
        // a exigencia de orcamento e POR ITEM (nao pela soma da solicitacao)
        var blocoOrcamento = bloco.querySelector('.bloco-orcamento-item');
        if (subtotal > LIMITE_COTACOES) {
            itensCaros.push('Item ' + (indice + 1) + ' (' + formatarValor(subtotal) + ')');
            blocoOrcamento.style.display = 'block';
        } else {
            blocoOrcamento.style.display = 'none';
        }
    });
    ...
    if (itensCaros.length > 0) {
        aviso.style.display = 'block';
        var plural = itensCaros.length > 1 ? 'passam' : 'passa';
        document.getElementById('lista_itens_caros').textContent =
            itensCaros.join(', ') + ' ' + plural + ' de ' + formatarValor(LIMITE_COTACOES) + '.';
    } else {
...
function renumerarItens() {
    ...
    for (var i = 0; i < blocos.length; i++) {
        ...
        // mantem o nome de CADA campo de orcamento ja adicionado neste item
        // sincronizado com a posicao atual do item (pode mudar se um item
        // do meio for removido)
        blocos[i].querySelectorAll('.campo-orcamento-item').forEach(function (campo) {
            campo.name = 'orcamento_item_' + i + '[]';
        });
    }
}
...
function ativarBloco(bloco) {
    ...
    var btnAdicionarOrcamento = bloco.querySelector('.btn-adicionar-orcamento');
    var listaCamposOrcamento = bloco.querySelector('.lista-campos-orcamento');

    function indiceAtualDoItem() {
        return Array.prototype.indexOf.call(document.querySelectorAll('.bloco-item'), bloco);
    }

    function atualizarConfirmacaoOrcamento() {
        var campos = listaCamposOrcamento.querySelectorAll('.campo-orcamento-item');
        var nomes = [];
        campos.forEach(function (campo) {
            if (campo.files.length > 0) { nomes.push(campo.files[0].name); }
        });
        var textoConfirmacao = bloco.querySelector('.texto-arquivos-selecionados');
        if (nomes.length === 0) {
            textoConfirmacao.innerHTML = '';
        } else {
            var cor = nomes.length >= 3 ? '#2e7d32' : '#c0392b';
            var situacao = nomes.length >= 3 ? 'pronto' : 'faltam ' + (3 - nomes.length);
            textoConfirmacao.innerHTML = '<strong style="color:' + cor + ';">' + nomes.length +
                '/3 anexado(s) - ' + situacao + '</strong><br>' + nomes.join(', ') +
                '<br><span style="font-size:10px;">Serão vinculados a ESTE item quando você ' +
                'clicar em "Enviar solicitação", no final do formulário.</span>';
        }
        btnAdicionarOrcamento.style.display = campos.length >= 3 ? 'none' : 'inline-block';
    }

    function adicionarCampoOrcamento() {
        var linha = document.createElement('div');
        linha.style.cssText = 'display:flex; align-items:center; gap:6px; margin-top:5px;';

        var campo = document.createElement('input');
        campo.type = 'file';
        campo.className = 'campo-orcamento-item';
        campo.accept = '.pdf,.jpg,.jpeg,.png';
        campo.style.cssText = 'font-size:12px; flex:1;';
        campo.name = 'orcamento_item_' + indiceAtualDoItem() + '[]';
        campo.addEventListener('change', atualizarConfirmacaoOrcamento);

        var btnRemover = document.createElement('button');
        btnRemover.type = 'button';
        btnRemover.textContent = '✕';
        btnRemover.title = 'Remover este orçamento';
        btnRemover.style.cssText = 'font-size:11px; padding:2px 7px; flex-shrink:0;';
        btnRemover.addEventListener('click', function () {
            linha.remove();
            atualizarConfirmacaoOrcamento();
        });

        linha.appendChild(campo);
        linha.appendChild(btnRemover);
        listaCamposOrcamento.appendChild(linha);
        atualizarConfirmacaoOrcamento();
    }

    btnAdicionarOrcamento.addEventListener('click', adicionarCampoOrcamento);
...
def montar_formulario_compras():
    return COMPRA_MATERIAIS_FORM_TEMPLATE.replace('__OPCOES_COORDENACAO__',
        ...
        .replace('__BLOCO_SHORTCUT_OBJETIVO_EPICO__', bloco_shortcut_objetivo_epico())
    ...
    if request.method == 'POST':
        ...
        for i in range(len(especificacoes)):
            ...
            itens.append({
                ...
                # guarda a posicao original no formulario - e por ela que o
                # campo de orcamento (orcamento_item_<i>[]) foi nomeado no
                # navegador, pode nao bater com a posicao final da lista
                # "itens" se algum item em branco tiver sido pulado
                '_indice_form': i,
            })
        ...
        # a exigencia de 3 orcamentos e POR ITEM (nao pela soma da
        # solicitacao) - a pessoa ja anexa na propria tela de criacao (campo
        # dentro de cada item), e o Executor fica travado de concluir a
        # compra sem isso. Nao bloqueia o ENVIO da solicitacao em si, so a
        # conclusao da compra depois.
        ...
        # cria todos os itens primeiro, com UM flush so no final (nao um por
        # item) - com solicitacoes de muitos itens, um flush por item soma
        # varias idas ao banco em sequencia, sem necessidade
        itens_criados = []
        for dados in itens:
            indice_form = dados.pop('_indice_form')
            item = SolicitacaoCompraMateriais(
                solicitacao_id=solicitacao.id,
                data_entrega_material=data_entrega,
                **dados,
            )
            db.session.add(item)
            itens_criados.append((item, indice_form))

        db.session.flush()  # gera o id de TODOS os itens de uma vez

        # cada orcamento anexado na criacao ja fica vinculado ao ITEM
        # especifico (item_compra_id), nao so ao protocolo - por isso o
        # flush acima acontece antes: precisa do id de cada item primeiro
        for item, indice_form in itens_criados:
            orcamentos_deste_item = request.files.getlist(f'orcamento_item_{indice_form}[]')
            for arquivo_orcamento in orcamentos_deste_item:
                if arquivo_orcamento and arquivo_orcamento.filename:
                    salvar_anexo(solicitacao.id, arquivo_orcamento, 'orcamento', item_compra_id=item.id)
...
def alimentacao_form():
    ...
    if request.method == 'POST':
        ...
        if not arquivo_lista or not arquivo_lista.filename:
            ...
            form_html = form_html.replace('__BLOCO_SHORTCUT_OBJETIVO_EPICO__', bloco_shortcut_objetivo_epico())
...
<form method="POST" style="max-width: 700px;" id="form-servico-pf">
    ...
    <div class="bloco" style="background:#eef4f8; border-left:4px solid #2b5876; max-width:750px; margin-bottom:14px;">
        <strong style="font-size:12.5px; color:#2b5876;">Aviso de privacidade</strong>
        <div style="font-size:11.5px; color:#555; margin-top:4px;">
            Os dados pessoais informados abaixo (nome, CPF, RG, telefone, PIS/NIS, endereço e
            dados bancários) são coletados exclusivamente para viabilizar a contratação e o
            pagamento deste serviço, incluindo o compartilhamento com a instituição bancária
            responsável pelo depósito. Os dados ficam armazenados enquanto a solicitação estiver
            ativa e pelo prazo necessário ao cumprimento de obrigações legais e de prestação de
            contas.
        </div>
    </div>
...
function htmlPrestadorPF(numero) {
    ...
    '<div class="bloco-prestador bloco" style="margin-bottom:15px;">' +
        ...
        '<label>Data de início da atividade:</label><br>' +
        '<input type="date" name="data_inicio_atividade[]" style="padding:6px; margin-bottom:10px;"><br>' +

        '<label>Data de fim da atividade:</label><br>' +
        '<input type="date" name="data_fim_atividade[]" style="padding:6px; margin-bottom:10px;"><br>' +
...
def servico_externo_pf_form():
    ...
    if request.method == 'POST':
        ...
        datas_inicio = request.form.getlist('data_inicio_atividade[]')
        datas_fim = request.form.getlist('data_fim_atividade[]')
        ...
        for i in range(len(nomes)):
            ...
            prestadores.append({
                ...
                'data_inicio_atividade': (datas_inicio[i] or None) if i < len(datas_inicio) else None,
                'data_fim_atividade': (datas_fim[i] or None) if i < len(datas_fim) else None,
                'valor_iss': valor_iss,
...
def cadastro_travar_solicitacoes():
    ...
    if request.method == 'POST':
        ...
        elif acao in ('desativar_email_aprovador', 'ativar_email_aprovador'):
            novo_valor = 0 if acao == 'desativar_email_aprovador' else 1
            registro_flag = Configuracao.query.filter_by(chave=CHAVE_NOTIFICAR_APROVADOR_EMAIL).first()
            if registro_flag:
                registro_flag.valor = novo_valor
            else:
                db.session.add(Configuracao(chave=CHAVE_NOTIFICAR_APROVADOR_EMAIL, valor=novo_valor))

            registrar_auditoria(acao, None, '')
            db.session.commit()
            flash('E-mail de nova pendência para o Aprovador ' +
                  ('desativado.' if novo_valor == 0 else 'reativado.'), 'sucesso')

        elif acao in ('desativar_shortcut', 'ativar_shortcut'):
            # só o Admin (is_organizador) mexe nisso - mesmo essa tela sendo
            # compartilhada com o Analista pras outras opções acima
            if not current_user.is_organizador:
                abort(403)
            novo_valor = 0 if acao == 'desativar_shortcut' else 1
            registro_flag = Configuracao.query.filter_by(chave=CHAVE_SHORTCUT_ATIVO).first()
            if registro_flag:
                registro_flag.valor = novo_valor
            else:
                db.session.add(Configuracao(chave=CHAVE_SHORTCUT_ATIVO, valor=novo_valor))

            registrar_auditoria(acao, None, '')
            db.session.commit()
            flash('Integração com o Shortcut ' +
                  ('pausada.' if novo_valor == 0 else 'reativada.'), 'sucesso')
    ...
    email_ligado = notificar_aprovador_por_email()
    if email_ligado:
        bloco_email = """
        <div class="bloco" style="border-left:4px solid #2e7d32; background:#eef5ee; max-width:700px;">
            <strong style="color:#2e7d32; font-size:14px;">📧 E-mail de nova pendência - ativado</strong>
            <div style="font-size:12px; margin-top:5px; color:#666;">
                O Aprovador recebe um e-mail toda vez que uma solicitação sai da Análise e chega
                para ele avaliar.
            </div>
        </div>
        <form method="POST" style="margin-top:10px;">
            <input type="hidden" name="acao" value="desativar_email_aprovador">
            <button type="submit" class="btn" style="padding:8px 16px; background:#b35c00; color:#fff;">
                Desativar e-mail para o Aprovador
            </button>
        </form>
        """
    else:
        bloco_email = """
        <div class="bloco" style="border-left:4px solid #b35c00; background:#fff8e6; max-width:700px;">
            <strong style="color:#b35c00; font-size:14px;">📧 E-mail de nova pendência - desativado</strong>
            <div style="font-size:12px; margin-top:5px; color:#666;">
                O Aprovador NÃO recebe mais e-mail quando uma solicitação chega pra ele - só vê ao
                entrar no sistema, na Fila de Aprovação. Os demais e-mails (aprovado, reprovado,
                devolvido) continuam normais.
            </div>
        </div>
        <form method="POST" style="margin-top:10px;">
            <input type="hidden" name="acao" value="ativar_email_aprovador">
            <button type="submit" class="btn btn-salvar" style="padding:8px 16px;">
                Reativar e-mail para o Aprovador
            </button>
        </form>
        """
    ...
    bloco_shortcut = ''
    if current_user.is_organizador:
        shortcut_ligado = shortcut_integracao_ativa()
        if shortcut_ligado:
            bloco_shortcut = """
            <h2 style="margin-top:32px;">Integração com o Shortcut</h2>
            <div style="font-size:12.5px; color:#666; margin-bottom:16px; max-width:700px;">
                Controla os campos "Objetivo vinculado" e "Épico vinculado" que aparecem em todos os
                formulários de solicitação. Visível só para o Admin.
            </div>
            <div class="bloco" style="border-left:4px solid #2e7d32; background:#eef5ee; max-width:700px;">
                <strong style="color:#2e7d32; font-size:14px;">🔗 Integração - ativada</strong>
                <div style="font-size:12px; margin-top:5px; color:#666;">
                    Os campos de Objetivo e Épico do Shortcut aparecem normalmente nos formulários.
                </div>
            </div>
            <form method="POST" style="margin-top:10px;" onsubmit="return confirm('Pausar a integração com o Shortcut? Os campos somem dos formulários até você reativar.');">
                <input type="hidden" name="acao" value="desativar_shortcut">
                <button type="submit" class="btn" style="padding:8px 16px; background:#b35c00; color:#fff;">
                    Pausar integração com o Shortcut
                </button>
            </form>
            """
        else:
            ...
            <div class="bloco" style="border-left:4px solid #b35c00; background:#fff8e6; max-width:700px;">
                <strong style="color:#b35c00; font-size:14px;">🔗 Integração - pausada</strong>
                <div style="font-size:12px; margin-top:5px; color:#666;">
                    Os campos de Objetivo e Épico do Shortcut estão ocultos em todos os formulários de
                    solicitação. Nenhum dado foi perdido - é só reativar quando quiser continuar.
                </div>
            </div>
            <form method="POST" style="margin-top:10px;">
                <input type="hidden" name="acao" value="ativar_shortcut">
                <button type="submit" class="btn btn-salvar" style="padding:8px 16px;">
                    Reativar integração com o Shortcut
                </button>
            </form>
            """
    ...
    <h2 style="margin-top:32px;">Notificações do Aprovador</h2>
    <div style="font-size:12.5px; color:#666; margin-bottom:16px; max-width:700px;">
        Controla só o e-mail avisando que uma nova solicitação chegou pra aprovar - útil se a
        caixa de entrada do Aprovador estiver ficando cheia. A pendência continua aparecendo
        normalmente dentro do sistema, mesmo com o e-mail desativado.
    </div>
    {bloco_email}
    {bloco_shortcut}
    """
...
<form method="POST" style="max-width: 850px;" id="form-rancho">
    ...
    <div class="bloco" style="background:#eef5ee; border-color:#c8ddc8;">
        ...
        <div style="font-size:12px; color:var(--texto); margin-top:6px; line-height:1.5;">
...
function recalcularUmItem(campo) {
    // a mesma logica de calcularQuantidades(), mas para UM item so - usada
    // tanto no calculo geral quanto ao desmarcar "Nao comprar" de um item
    ...
    if ((caixa && caixa.checked) || !aplicavel || pessoas <= 0 || dias <= 0) {
        campo.value = 0;
    ...
    // é preenchido manualmente, exceto se marcado "não comprar" ou fora da
    // refeição escolhida (já tratado acima)
}
...
function calcularQuantidades() {
    ...
    document.querySelectorAll('.qtd-item').forEach(recalcularUmItem);
...
document.querySelectorAll('.nao-comprar').forEach(function(caixa) {
    caixa.addEventListener('change', function() {
        ...
        if (caixa.checked) {
            ...
            recalcularUmItem(campo);  // devolve a quantidade sugerida, em vez de deixar zerado
        }
        atualizarSubtotais();
        verificarAumentoQuantidade();
    });
...
<form method="POST" enctype="multipart/form-data" style="max-width: 750px;" id="form-seguro">
    ...
    <div class="bloco" style="background:#eef4f8; border-left:4px solid #2b5876; max-width:750px; margin-bottom:14px;">
        <strong style="font-size:12.5px; color:#2b5876;">Aviso de privacidade</strong>
        <div style="font-size:11.5px; color:#555; margin-top:4px;">
            Os dados pessoais informados abaixo (nome, data de nascimento, CPF, RG, e-mail,
            telefone e endereço) são coletados exclusivamente para viabilizar a contratação do
            seguro de viagem, incluindo o compartilhamento com a seguradora responsável pela
            apólice. Os dados ficam armazenados enquanto a solicitação estiver ativa e pelo prazo
            necessário ao cumprimento de obrigações legais e de prestação de contas.
        </div>
    </div>
...
<form method="POST" enctype="multipart/form-data" style="max-width: 750px;" id="form-bolsa">
    ...
    <div class="bloco" style="background:#eef4f8; border-left:4px solid #2b5876; max-width:750px; margin-bottom:14px;">
        <strong style="font-size:12.5px; color:#2b5876;">Aviso de privacidade</strong>
        <div style="font-size:11.5px; color:#555; margin-top:4px;">
            O nome do(a) bolsista informado abaixo é coletado exclusivamente para viabilizar o
            pagamento da bolsa. Os dados ficam armazenados enquanto a solicitação estiver ativa e
            pelo prazo necessário ao cumprimento de obrigações legais e de prestação de contas.
        </div>
    </div>
...
def _dados_edicao_servico_pf(solicitacao):
    ...
    for p in prestadores:
        ...
        pares.append(('data_inicio_atividade[]',
                      p.data_inicio_atividade.strftime('%Y-%m-%d') if p.data_inicio_atividade else ''))
        pares.append(('data_fim_atividade[]',
                      p.data_fim_atividade.strftime('%Y-%m-%d') if p.data_fim_atividade else ''))
...
def corrigir_solicitacao(solicitacao_id):
    ...
    if rota_criacao:
        aviso_itens = f"""
        <div class="bloco aviso-orcamento" style="border-left:4px solid var(--aviso-borda);">
...
LISTA_COMPRAS_MATERIAIS_TEMPLATE = """
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="cabecalho">
        <h1>SIGAD Carajás — Lista de Compras de Materiais</h1>
        <div class="protocolo">Protocolo {{ protocolo }}</div>
    </div>
    ...
    <table>
        <tr>
            ...
            <th>Item</th>
            <th>Fornecedor</th>
            <th style="width:60px;">Aquisição</th>
...
@app.route('/solicitacao/<int:solicitacao_id>/compra-materiais/lista-compras')
@login_required
def lista_compras_materiais(solicitacao_id):
    solicitacao = Solicitacao.query.get_or_404(solicitacao_id)
    ...
    todos_itens = SolicitacaoCompraMateriais.query.filter_by(
        solicitacao_id=solicitacao.id
    ).order_by(SolicitacaoCompraMateriais.id).all()

    # so entram na lista de compra os itens que nao foram reprovados -
    # o Executor nao deve comprar o que foi reprovado
    itens = [i for i in todos_itens if i.status_aprovacao_item != 'reprovado']
    reprovados = [i for i in todos_itens if i.status_aprovacao_item == 'reprovado']

    linhas = ''
    total_apurado = 0
    for item in itens:
        total_apurado += float(item.valor_total_item or 0)
        link_html = (f' <a href="{item.link_produto}" style="font-size:10px;">(link)</a>'
                     if item.link_produto else '')
        linhas += (
            f'<tr>'
            f'<td class="marcar">☐</td>'
            f'<td>{item.nome_especificacao}{link_html}</td>'
            f'<td>{item.fornecedor_sugerido or "-"}</td>'
            f'<td>{item.forma_aquisicao or "-"}</td>'
            f'<td class="num">{float(item.quantidade or 0):.0f}</td>'
            f'<td class="num">{moeda(item.valor_unitario)}</td>'
            f'<td class="num">{moeda(item.valor_total_item)}</td>'
            f'</tr>'
    ...
    if not linhas:
        linhas = '<tr><td colspan="7">Nenhum item liberado para compra nesta solicitação.</td></tr>'

    bloco_reprovados = ''
    if reprovados:
        linhas_rep = ''.join(
            f'<li>{i.nome_especificacao} — {i.motivo_reprovacao_item or "sem motivo registrado"}</li>'
            for i in reprovados
        )
        bloco_reprovados = (
            '<div class="observacao"><strong>Itens reprovados (NÃO comprar):</strong>'
            f'<ul style="margin:6px 0 0; padding-left:18px;">{linhas_rep}</ul></div>'
        )
    ...
    return render_template_string(
        ...
        coordenacao=(solicitacao.coordenacao_solicitante.nome
                     if solicitacao.coordenacao_solicitante else '-'),
        data_entrega=(itens[0].data_entrega_material.strftime('%d/%m/%Y')
                      if itens and itens[0].data_entrega_material else '-'),
        convenio=solicitacao.convenio or '-',
        linhas=linhas,
        total=moeda(total_apurado),
        bloco_reprovados=bloco_reprovados,
        gerado_em=agora().strftime('%d/%m/%Y'),
        voltar=url_for('detalhe_solicitacao', solicitacao_id=solicitacao.id),
    )
...
def anexar_comprovante_posterior(solicitacao_id):
    ...
    pode = (current_user.is_organizador
            ...
            or current_user.perfil in ('comprador', 'analista'))
    if not pode:
        abort(403)
...
@app.route('/solicitacao/<int:solicitacao_id>/cancelar', methods=['POST'])
@login_required
def cancelar_solicitacao(solicitacao_id):
    solicitacao = Solicitacao.query.get_or_404(solicitacao_id)

    eh_dono = solicitacao.solicitante_id == current_user.id
    eh_analista_ou_aprovador = (current_user.perfil in ('analista', 'aprovador')
                                or current_user.is_organizador)

    # cenario 1: o proprio Solicitante cancela, enquanto ainda nao foi analisada
    if solicitacao.status == 'pendente_analise' and (eh_dono or current_user.is_organizador):
        solicitacao.status = 'cancelada'
        registrar_auditoria('cancelou', solicitacao,
                            f'Cancelada pelo próprio solicitante ({current_user.nome})')
        db.session.commit()
        flash('Solicitação cancelada.', 'sucesso')
        return redirect(url_for('minhas_solicitacoes'))

    # cenario 2: Analista ou Aprovador cancela uma solicitacao ja aprovada
    # (ex: a atividade que motivou o pedido foi cancelada) - exige justificativa
    if solicitacao.status == 'aprovada' and eh_analista_ou_aprovador:
        justificativa = (request.form.get('justificativa_cancelamento') or '').strip()
        if not justificativa:
            flash('Informe a justificativa para cancelar esta solicitação.')
            return redirect(url_for('detalhe_solicitacao', solicitacao_id=solicitacao_id))

        solicitacao.status = 'cancelada'
        registrar_auditoria('cancelou', solicitacao,
                            f'Cancelada por {current_user.nome} ({current_user.perfil}) - {justificativa}')
        db.session.commit()

        tipo_label = TIPO_SOLICITACAO_LABELS.get(solicitacao.tipo, solicitacao.tipo)
        notificar_solicitante(
            solicitacao,
            'Solicitação cancelada - SIGAD Carajás',
            f'Olá, {solicitacao.solicitante.nome}.\n\n'
            f'Sua solicitação de {tipo_label}, protocolo {protocolo(solicitacao)}, já aprovada, '
            f'foi cancelada por {current_user.nome}.\n\n'
            f'Justificativa: {justificativa}',
        )
...
def detalhe_solicitacao(solicitacao_id):
    ...
    ] + ([('Objetivo (Shortcut)', solicitacao.shortcut_objetivo_nome)] if solicitacao.shortcut_objetivo_nome else [])
      + ([('Épico (Shortcut)', solicitacao.shortcut_epico_nome)] if solicitacao.shortcut_epico_nome else []))
    ...
    LARGOS = ('Justificativa', 'Especificação', 'Percurso / paradas', 'Observação',
              ...
              'Percurso / Pontos de parada', 'Endereço', 'Aprovação', 'Orçamentos')
        ...
        if d:
            ...
            for indice, diarista in enumerate(diarias_lista, start=1):
                corpo += tabela(f'Diarista {indice} - {diarista.nome_diarista}', [
                    ...
                    ('Aprovação deste diarista', celula_reprovar_item(diarista, solicitacao)),
                ])
            ...
            if solicitacao.status in ('aprovada', 'em_execucao', 'enviado_pagamento', 'paga'):
                ...
                for diaria in diarias_lista:
                    rotulo_p, cor_p, dias_p, prazo_p = situacao_prestacao(diaria, solicitacao)

                    if diaria.prestacao_contas_entregue:
                        aprovador_p = diaria.prestacao_aprovada_por or '-'
                        acao_p = (f'<div style="font-size:13px; color:#2e7d32; margin-top:8px;">'
                                  f'Aprovada em {diaria.data_prestacao_contas.strftime("%d/%m/%Y")} '
                                  f'por {aprovador_p}. O relatório está na lista de anexos abaixo.</div>')

                    elif diaria.relatorio_em_conferencia:
                        enviado_em = (diaria.data_relatorio_enviado.strftime('%d/%m/%Y')
                                      if diaria.data_relatorio_enviado else '-')
                        tem_relatorio_anexado = Anexo.query.filter_by(
                            diaria_id=diaria.id, tipo_anexo='prestacao_contas').count()

                        if pode_avaliar_prestacao() and not tem_relatorio_anexado:
                            acao_p = ('<div style="font-size:13px; color:#c0392b; margin-top:8px;">'
                                      'Este relatório está marcado como aguardando conferência, mas '
                                      'nenhum arquivo foi anexado. Devolva para reenvio.</div>')
                            ...
                            <form method="POST" action="{url_for('avaliar_prestacao_contas', solicitacao_id=solicitacao.id, diaria_id=diaria.id)}"
                                  id="form-prestacao-{diaria.id}">
                                <label>Motivo da devolução (obrigatório para devolver):</label><br>
                                <textarea name="motivo" id="motivo-prestacao-{diaria.id}" rows="3"
                            ...
                            <script>
                            document.getElementById('form-prestacao-{diaria.id}').addEventListener('submit', function(evento) {{
                                var acao = evento.submitter ? evento.submitter.value : '';
                                var motivo = document.getElementById('motivo-prestacao-{diaria.id}').value.trim();
                        ...
                        recusa_html = ''
                        if diaria.motivo_recusa_prestacao:
                            recusa_html = (
                                ...
                                f'{diaria.motivo_recusa_prestacao}</div>'
                            )

                        acao_p = recusa_html + f"""
                        <form method="POST" action="{url_for('registrar_prestacao_contas', solicitacao_id=solicitacao.id, diaria_id=diaria.id)}"
                              enctype="multipart/form-data" style="margin-top:10px;">
                            <label>Relatório de viagem de {diaria.nome_diarista}: <span style="color:red;">*</span></label><br>
                    ...
                    blocos_prestacao += f"""
                    <div class="bloco" style="max-width:700px; border-left:4px solid {cor_p}; margin-bottom:12px;">
                        <strong style="font-size:13px;">{diaria.nome_diarista}</strong>
                        ...
                        <div style="font-size:12px; color:#666; margin-top:5px;">
                            ...
                            ({PRAZO_PRESTACAO_DIAS} dias corridos após o retorno em {diaria.data_retorno.strftime('%d/%m/%Y')}).
                        </div>
                        {acao_p}
                    </div>
                    """
                ...
                <div style="font-size:11.5px; color:#888; margin-bottom:10px; max-width:700px;">
                    Cada diarista desta solicitação envia e tem o próprio relatório de viagem
                    conferido de forma independente - o CPF de cada um só é desbloqueado quando
                    ELE enviar o relatório dele, não quando qualquer um dos outros enviar.
                </div>
                {blocos_prestacao}
                """
    ...
    if solicitacao.tipo == 'passagem':
        ...
        if passageiros:
            ...
            for indice, p in enumerate(passageiros, start=1):
                ...
                campos.append(('Aprovação deste passageiro', celula_reprovar_item(p, solicitacao), 'largo'))
        ...
        if itens_compra:
            ...
            for indice, c in enumerate(itens_compra, start=1):
                ...
                <tr>
                    ...
                    <td style="width:150px;">{celula_reprovar_item(c, solicitacao)}</td>
                    <td style="width:220px;">{celula_orcamentos_item(
                        c, solicitacao, c.valor_total_item, 'item_compra_id',
                        url_for('anexar_orcamento_item_compra', solicitacao_id=solicitacao.id, item_id=c.id),
                        c.nome_especificacao)}</td>
                </tr>
                """
            ...
            <div style="margin-bottom:12px;">
                <a href="{url_for('lista_compras_materiais', solicitacao_id=solicitacao.id)}" target="_blank"
                ...
                <span style="font-size:11px; color:#666; margin-left:8px;">
                    Abre em nova aba, pronta para imprimir ou salvar em PDF. Itens reprovados ficam de fora da lista.
                </span>
            </div>
            <table style="max-width:1450px;">
                <tr>
                    ...
                    <th style="width:120px;">Total</th><th style="width:150px;">Ação</th>
                    <th style="width:220px;">Orçamentos (item &gt; R$5.000)</th>
                </tr>
                {linhas_compra}
    ...
    if solicitacao.tipo in ('servico_externo', 'servico_externo_pf', 'servico_externo_pj'):
        ...
        for indice, pr in enumerate(prestadores, start=1):
            ...
            campos_valor = (
                [
                    ...
                    ('Data de início da atividade',
                     pr.data_inicio_atividade.strftime('%d/%m/%Y') if pr.data_inicio_atividade else '-'),
                    ('Data de fim da atividade',
                     pr.data_fim_atividade.strftime('%d/%m/%Y') if pr.data_fim_atividade else '-'),
            ...
            campos_aprovacao_pf = (
                [
                    ('Aprovação deste prestador', celula_reprovar_item(pr, solicitacao)),
                    ('Orçamentos (prestador acima de R$5.000)', celula_orcamentos_item(
                        pr, solicitacao, pr.valor_servico, 'prestador_id',
                        url_for('anexar_orcamento_prestador', solicitacao_id=solicitacao.id, prestador_id=pr.id),
                        pr.nome_prestador)),
                ]
                if solicitacao.tipo in ('servico_externo_pf', 'servico_externo_pj') else []
            )
    ...
    if solicitacao.tipo == 'rancho':
        ...
        for item in itens:
            ...
            <tr>
                ...
                <td style="width:140px;">{celula_reprovar_item(item, solicitacao)}</td>
            </tr>
            """

        if not linhas_itens:
            linhas_itens = '<tr><td colspan="7">Nenhum item nesta solicitação.</td></tr>'
        ...
        <table style="max-width:1000px;">
            <tr>
                ...
                <th style="width:140px;">Reprovar</th>
            </tr>
            {linhas_itens}
        </table>
    ...
    if solicitacao.tipo == 'seguro':
        ...
        for p in participantes:
            ...
            <tr>
                ...
                <td style="width:140px;">{celula_reprovar_item(p, solicitacao)}</td>
            </tr>
            """

        if not linhas_part:
            linhas_part = '<tr><td colspan="8">Nenhum participante cadastrado.</td></tr>'

        corpo += f"""
        <h3>Participantes do seguro de vida</h3>
        <table style="max-width:1250px;">
            <tr>
                <th>Nome completo</th><th>Nascimento</th><th>CPF</th><th>RG</th>
                <th>E-mail</th><th>Telefone</th><th>Endereço</th><th>Aprovação</th>
            </tr>
            {linhas_part}
        </table>
        <div style="font-size:11px; color:#888; margin-top:6px;">
    ...
    if solicitacao.tipo == 'bolsa':
        ...
        for indice, b in enumerate(bolsistas, start=1):
            ...
            <tr>
                ...
                <td style="width:150px;">{celula_reprovar_item(b, solicitacao)}</td>
            </tr>
            """

        if not linhas_bolsa:
            linhas_bolsa = '<tr><td colspan="11">Nenhum bolsista cadastrado.</td></tr>'

        corpo += f"""
        <h3>Bolsistas</h3>
        <table style="max-width:1350px;">
            <tr>
                <th>Item</th><th>Nome do bolsista</th><th>Plano de Trabalho</th><th>Projeto</th>
                <th>Tipo de Bolsa</th><th>Período</th><th>Meses</th>
                <th>Valor mensal</th><th>Valor total</th><th>Crachá</th><th>Aprovação</th>
            </tr>
            {linhas_bolsa}
        </table>
        """
    ...
    eh_dono_da_solicitacao = solicitacao.solicitante_id == current_user.id
    if solicitacao.status == 'pendente_analise' and eh_dono_da_solicitacao:
        painel += f"""
        <div class="bloco" style="max-width:750px; border-left:4px solid #c0392b;">
            <strong style="font-size:14px;">Cancelar esta solicitação</strong>
            <div style="font-size:12.5px; color:#666; margin:6px 0 10px;">
                Só é possível cancelar enquanto ninguém analisou a solicitação ainda.
                Depois disso, essa opção deixa de estar disponível.
            </div>
            <form method="POST" action="{url_for('cancelar_solicitacao', solicitacao_id=solicitacao.id)}"
                  onsubmit="return confirm('Tem certeza que deseja cancelar esta solicitação? Essa ação não pode ser desfeita.');">
                <button type="submit" class="btn btn-excluir" style="padding:8px 16px;">Cancelar solicitação</button>
            </form>
        </div>
        """

    eh_analista_ou_aprovador_geral = (current_user.perfil in ('analista', 'aprovador')
                                      or current_user.is_organizador)
    if solicitacao.status == 'aprovada' and eh_analista_ou_aprovador_geral:
        painel += f"""
        <div class="bloco" style="max-width:750px; border-left:4px solid #c0392b;">
            <strong style="font-size:14px;">Cancelar esta solicitação</strong>
            <div style="font-size:12.5px; color:#666; margin:6px 0 10px;">
                Use quando a atividade que motivou o pedido foi cancelada, mesmo já estando
                aprovado. O solicitante é avisado por e-mail com a justificativa informada.
            </div>
            <form method="POST" action="{url_for('cancelar_solicitacao', solicitacao_id=solicitacao.id)}"
                  onsubmit="return confirm('Tem certeza que deseja cancelar esta solicitação já aprovada? Essa ação não pode ser desfeita.');">
                <label style="font-size:12.5px;">Justificativa do cancelamento: <span style="color:red;">*</span></label><br>
                <textarea name="justificativa_cancelamento" required rows="3"
                          style="width:100%; padding:6px; margin:4px 0 10px;"></textarea>
                <button type="submit" class="btn btn-excluir" style="padding:8px 16px;">Cancelar solicitação</button>
            </form>
        </div>
        """
...
{campo_encaminhamento}
    ...
    if painel:
        painel += """
        <script>
        document.querySelectorAll('.checkbox-reprovar-item').forEach(function (caixa) {
            caixa.addEventListener('change', function () {
                var bloco = document.getElementById('motivo-item-' + caixa.dataset.itemId);
                if (bloco) { bloco.style.display = caixa.checked ? 'block' : 'none'; }
            });
        });
            ...
            if (acao === 'aprovar' || acao === 'enviar') {
                ...
                document.querySelectorAll('.checkbox-reprovar-item:checked').forEach(function (caixa) {
                    ...
                    if (campoMotivo && campoMotivo.value.trim() === '') {
                        itensSemMotivo.push(caixa);
                    }
                });
                if (itensSemMotivo.length > 0) {
                    evento.preventDefault();
                    alert('Preencha a justificativa de reprovação para cada item marcado.');
                }
            }
        });
        </script>
...
def exportar_relatorio():
    ...
    # carrega as diarias de uma vez so, pra nao fazer uma consulta por linha
    # do relatorio - guarda uma LISTA por solicitacao, ja que pode ter mais
    # de um diarista com situacoes diferentes de prestacao de contas
    ids_diaria = [s.id for s in solicitacoes if s.tipo == 'diaria']
    diaristas_por_solicitacao_csv = {}
    if ids_diaria:
        for registro in SolicitacaoDiaria.query.filter(
                SolicitacaoDiaria.solicitacao_id.in_(ids_diaria)).all():
            diaristas_por_solicitacao_csv.setdefault(registro.solicitacao_id, []).append(registro)

    for s in solicitacoes:
        if s.tipo != 'diaria':
            prestacao = '-'
        else:
            diaristas_csv = diaristas_por_solicitacao_csv.get(s.id, [])
            if not diaristas_csv:
                prestacao = '-'
            elif all(d.prestacao_contas_entregue for d in diaristas_csv):
                prestacao = 'Aprovada' if len(diaristas_csv) == 1 else f'Aprovada ({len(diaristas_csv)} diaristas)'
            elif any(d.relatorio_em_conferencia for d in diaristas_csv):
                prestacao = 'Em conferência'
            else:
                pendentes_csv = sum(1 for d in diaristas_csv if not d.prestacao_contas_entregue)
                prestacao = 'Pendente' if len(diaristas_csv) == 1 else f'Pendente ({pendentes_csv} de {len(diaristas_csv)} diaristas)'
...
def situacao_prestacao(diaria, solicitacao):
    ...
    DESTE diarista - cada pessoa numa mesma solicitação tem sua própria
    situação, independente das demais."""
    from datetime import timedelta
    ...
    if diaria.relatorio_em_conferencia:
...
def prestacoes_nao_aprovadas_por_cpf(cpf):
    ...
    registros = db.session.query(Solicitacao, SolicitacaoDiaria).join(
        ...
        Solicitacao.tipo == 'diaria',
        Solicitacao.status.in_(('aprovada', 'em_execucao', 'enviado_pagamento', 'paga')),
        SolicitacaoDiaria.data_relatorio_enviado.is_(None),
...
def prestacao_contas():
    ...
    # cada diarista tem prestação de contas própria - uma linha por pessoa,
    # mesmo quando o protocolo é compartilhado por várias na mesma viagem
    linhas = []
    ...
    total_atraso = sum(1 for item in linhas if item[4] > 0)

    # atrasadas primeiro, depois por prazo
    linhas.sort(key=lambda item: (-item[4], item[5]))
    ...
    for solicitacao, diaria, rotulo, cor, dias_atraso, prazo_final in linhas:
        ...
        entrega = diaria.data_prestacao_contas.strftime('%d/%m/%Y') if diaria.data_prestacao_contas else '-'
        aprovador = ''
        if diaria.prestacao_aprovada_por:
            aprovador = f'<br><span style="font-size:10.5px; color:#666;">{diaria.prestacao_aprovada_por}</span>'
        elif diaria.relatorio_em_conferencia and diaria.data_relatorio_enviado:
            aprovador = (f'<br><span style="font-size:10.5px; color:#b35c00;">enviado em '
                         f'{diaria.data_relatorio_enviado.strftime("%d/%m/%Y")}</span>')
    ...
    <table style="max-width:1150px;">
        <tr>
            <th>Protocolo</th><th>Diarista(s)</th><th>Solicitante</th><th>Período da viagem</th>
...
@app.route('/solicitacao/<int:solicitacao_id>/diaria/<int:diaria_id>/prestacao-contas', methods=['POST'])
@login_required
def registrar_prestacao_contas(solicitacao_id, diaria_id):
    solicitacao = Solicitacao.query.get_or_404(solicitacao_id)
    diaria = SolicitacaoDiaria.query.get_or_404(diaria_id)

    if diaria.solicitacao_id != solicitacao.id:
        abort(404)
    ...
    if not arquivo or not arquivo.filename:
        flash(f'Anexe o relatório de viagem de {diaria.nome_diarista}.')
        return redirect(url_for('detalhe_solicitacao', solicitacao_id=solicitacao_id))

    salvar_anexo(solicitacao.id, arquivo, 'prestacao_contas', diaria_id=diaria.id)

    diaria.relatorio_em_conferencia = True
    diaria.data_relatorio_enviado = hoje()
    diaria.motivo_recusa_prestacao = None
    registrar_auditoria('enviou_relatorio', solicitacao,
                        f'Diarista: {diaria.nome_diarista} | Arquivo: {arquivo.filename}')
    db.session.commit()

    corpo = (
        f'O relatório de viagem da solicitação {protocolo(solicitacao)} foi enviado por '
        f'{current_user.nome}.\n\n'
        f'Diarista: {diaria.nome_diarista}\n'
...
@app.route('/solicitacao/<int:solicitacao_id>/diaria/<int:diaria_id>/prestacao-contas/avaliar', methods=['POST'])
@login_required
def avaliar_prestacao_contas(solicitacao_id, diaria_id):
    ...
    if not diaria.relatorio_em_conferencia:
        flash(f'Não há relatório de {diaria.nome_diarista} aguardando conferência.')
        return redirect(url_for('detalhe_solicitacao', solicitacao_id=solicitacao_id))
    ...
    if acao == 'aprovar':
        # não se aprova prestação sem o documento correspondente DESTE diarista
        tem_relatorio = Anexo.query.filter_by(
            diaria_id=diaria.id, tipo_anexo='prestacao_contas').count()

        if not tem_relatorio:
            flash(f'Não é possível aprovar: nenhum relatório de viagem de {diaria.nome_diarista} '
                  f'foi anexado.')
            return redirect(url_for('detalhe_solicitacao', solicitacao_id=solicitacao_id))

        diaria.prestacao_contas_entregue = True
        diaria.data_prestacao_contas = hoje()
        diaria.relatorio_em_conferencia = False
        diaria.motivo_recusa_prestacao = None
        diaria.prestacao_aprovada_por = f'{current_user.nome} ({perfil})'
        registrar_auditoria('aprovou_prestacao', solicitacao, f'Diarista: {diaria.nome_diarista}')
        db.session.commit()
        ...
        notificar_solicitante(
            ...
            f'Olá, {solicitacao.solicitante.nome}.\n\n'
            f'A prestação de contas de {diaria.nome_diarista}, na sua solicitação protocolo '
            f'{protocolo(solicitacao)}, foi conferida e aprovada por {current_user.nome}.\n\n'
            f'A pendência desse diarista foi baixada e não impede novas diárias para ele(a).',
        )

        flash(f'Prestação de contas de {diaria.nome_diarista} aprovada. Pendência baixada.', 'sucesso')
        return redirect(url_for('detalhe_solicitacao', solicitacao_id=solicitacao_id))
    ...
    if acao == 'recusar':
        ...
        diaria.relatorio_em_conferencia = False
        diaria.prestacao_contas_entregue = False
        diaria.motivo_recusa_prestacao = f'{motivo} (devolvido por {current_user.nome} - {perfil})'
        registrar_auditoria('devolveu_prestacao', solicitacao, f'Diarista: {diaria.nome_diarista} | {motivo}')
        db.session.commit()
        ...
        notificar_solicitante(
            ...
            f'Olá, {solicitacao.solicitante.nome}.\n\n'
            f'O relatório de viagem de {diaria.nome_diarista}, na sua solicitação protocolo '
            f'{protocolo(solicitacao)}, foi conferido e devolvido para correção.\n\n'
            f'Motivo: {motivo}\n\n'
            f'Acesse o sistema, corrija as informações e envie o relatório desse diarista '
            f'novamente. A pendência permanece em aberto até a aprovação.',
        )

        flash(f'Relatório de {diaria.nome_diarista} devolvido para correção.', 'sucesso')
        return redirect(url_for('detalhe_solicitacao', solicitacao_id=solicitacao_id))
...
@app.route('/solicitacao/<int:solicitacao_id>/item-compra/<int:item_id>/orcamento', methods=['POST'])
@login_required
def anexar_orcamento_item_compra(solicitacao_id, item_id):
    solicitacao = Solicitacao.query.get_or_404(solicitacao_id)
    item = SolicitacaoCompraMateriais.query.get_or_404(item_id)
    ...
    arquivos = request.files.getlist('orcamentos')
    enviados = 0
    for arquivo in arquivos:
        if arquivo and arquivo.filename:
            sucesso, _msg = salvar_anexo(solicitacao.id, arquivo, 'orcamento', item_compra_id=item.id)
            if sucesso:
                enviados += 1

    db.session.commit()
    if enviados:
        registrar_auditoria('anexou_orcamento_item', solicitacao,
                            f'{enviados} orçamento(s) para o item "{item.nome_especificacao}"')
        flash(f'{enviados} orçamento(s) anexado(s) para este item.', 'sucesso')
    else:
...
@app.route('/solicitacao/<int:solicitacao_id>/prestador/<int:prestador_id>/orcamento', methods=['POST'])
@login_required
def anexar_orcamento_prestador(solicitacao_id, prestador_id):
    solicitacao = Solicitacao.query.get_or_404(solicitacao_id)
    prestador = PrestadorServico.query.get_or_404(prestador_id)

    if prestador.solicitacao_id != solicitacao.id:
        abort(404)
    ...
    for arquivo in arquivos:
        if arquivo and arquivo.filename:
            sucesso, _msg = salvar_anexo(solicitacao.id, arquivo, 'orcamento', prestador_id=prestador.id)
            if sucesso:
                enviados += 1

    db.session.commit()
    if enviados:
        registrar_auditoria('anexou_orcamento_prestador', solicitacao,
                            f'{enviados} orçamento(s) para o prestador "{prestador.nome_prestador}"')
        flash(f'{enviados} orçamento(s) anexado(s) para este prestador.', 'sucesso')
    else:
        flash('Nenhum arquivo válido foi enviado.')
...
def remover_anexo(anexo_id):
    ...
    if eh_dono and not eh_fluxo:
        if anexo.tipo_anexo == 'prestacao_contas' and anexo.diaria and anexo.diaria.prestacao_contas_entregue:
    ...
    if tipo == 'prestacao_contas' and diaria_do_anexo:
        # só reabre a pendência DESTE diarista - os demais, se houver,
        # continuam com a própria situação intacta
        restantes = Anexo.query.filter_by(
            diaria_id=diaria_do_anexo.id, tipo_anexo='prestacao_contas').count()
        if not restantes:
            diaria_do_anexo.relatorio_em_conferencia = False
            diaria_do_anexo.prestacao_contas_entregue = False
            diaria_do_anexo.data_relatorio_enviado = None
            diaria_do_anexo.data_prestacao_contas = None
            diaria_do_anexo.prestacao_aprovada_por = None
...
def cadastro_coordenacao():
    ...
    for coord in coordenacoes:
        ...
        <tr>
            ...
            <td><input type="text" name="nome_shortcut" value="{coord.nome_shortcut or ''}"
                       placeholder="Ex: nome exato do Team no Shortcut" style="width:260px; padding:4px;"></td>
            <td><textarea name="shortcut_objetivos_ignorados" rows="2" style="width:220px; padding:4px; font-size:11.5px;"
                       placeholder="Um nome de objetivo por linha, pra nunca aparecer aqui">{coord.shortcut_objetivos_ignorados or ''}</textarea></td>
            <td>
                <button type="submit" class="btn btn-salvar">Salvar</button>
            </form>
    ...
    conteudo = f"""
    <h2>Coordenações</h2>
    <div style="font-size:12px; color:#666; margin-bottom:14px; max-width:700px;">
        "Nome no Shortcut" é opcional — coloque o nome exato do <strong>Team/Grupo</strong> dessa
        coordenação lá no Shortcut (o mesmo nome que aparece na lista de Teams de lá, não o nome de
        um objetivo específico). O sistema usa isso pra mostrar, na solicitação, só os objetivos dos
        épicos que pertencem àquele Team. Se algum objetivo aparecer errado mesmo assim (por exemplo,
        um épico do time que também está vinculado a um objetivo de outra área), cole o nome exato
        dele em "Objetivos a ignorar" — um por linha — pra escondê-lo dessa coordenação.
    </div>
    <table>
        <tr><th>Nome</th><th>Nome no Shortcut (Team/Grupo)</th><th>Objetivos a ignorar</th><th>Ações</th></tr>
        {linhas_html}
    </table>
...
def cadastro_coordenacao_atualizar(coordenacao_id):
    ...
    coord.nome_shortcut = request.form.get('nome_shortcut', '').strip() or None
    coord.shortcut_objetivos_ignorados = request.form.get('shortcut_objetivos_ignorados', '').strip() or None
    db.session.commit()
...
AJUSTES_SCHEMA = [
    ...
    # link de produto de loja online, com parametros de rastreamento
    # (gclid, gbraid, tracking_id...), passa facil de 500 caracteres -
    # amplia pra sem limite fixo, evitando erro ao gravar varios itens de
    # uma vez (StringDataRightTruncation, que derruba o lote inteiro)
    'ALTER TABLE solicitacao_compras_materiais ALTER COLUMN link_produto TYPE TEXT',

    # nome/titulo de produto e nome de fornecedor tambem vem de titulo de
    # pagina de loja online as vezes - mesmo motivo do link acima
    'ALTER TABLE solicitacao_compras_materiais ALTER COLUMN nome_especificacao TYPE TEXT',
    'ALTER TABLE solicitacao_compras_materiais ALTER COLUMN fornecedor_sugerido TYPE TEXT',

    # mesma familia de risco (texto livre digitado/colado) em locacao de
    # veiculo, servico externo e seguro - amplia todos de uma vez, pra nao
    # repetir esse mesmo tipo de erro campo por campo
    'ALTER TABLE solicitacao_locacao_veiculos ALTER COLUMN especificacoes TYPE TEXT',
    'ALTER TABLE solicitacao_locacao_veiculos ALTER COLUMN local_origem TYPE TEXT',
    'ALTER TABLE solicitacao_locacao_veiculos ALTER COLUMN percurso TYPE TEXT',
    'ALTER TABLE solicitacao_locacao_veiculos ALTER COLUMN local_retorno TYPE TEXT',
    'ALTER TABLE prestadores_servico ALTER COLUMN nome_servico TYPE TEXT',
    'ALTER TABLE prestadores_servico ALTER COLUMN fornecedor_sugerido TYPE TEXT',
    'ALTER TABLE solicitacao_seguros ALTER COLUMN local_origem TYPE TEXT',
    'ALTER TABLE solicitacao_seguros ALTER COLUMN percurso TYPE TEXT',
    'ALTER TABLE solicitacao_seguros ALTER COLUMN local_retorno TYPE TEXT',

    # campos sensiveis (CPF, RG, PIS/NIS, dados bancarios) passam a ser
    # criptografados na aplicacao (ver CampoCriptografado) - o valor
    # criptografado fica bem maior que o original, entao a coluna precisa
    # virar TEXT (sem limite fixo) pra caber
    'ALTER TABLE solicitacao_diarias ALTER COLUMN cpf_diarista TYPE TEXT',
    'ALTER TABLE solicitacao_diarias ALTER COLUMN banco_diarista TYPE TEXT',
    'ALTER TABLE solicitacao_diarias ALTER COLUMN agencia_diarista TYPE TEXT',
    'ALTER TABLE solicitacao_diarias ALTER COLUMN conta_diarista TYPE TEXT',
    'ALTER TABLE solicitacao_diarias ALTER COLUMN chave_pix TYPE TEXT',
    'ALTER TABLE solicitacao_passagens ALTER COLUMN cpf_passageiro TYPE TEXT',
    'ALTER TABLE solicitacao_passagens ALTER COLUMN rg_orgao_uf_passageiro TYPE TEXT',
    'ALTER TABLE prestadores_servico ALTER COLUMN cpf_prestador TYPE TEXT',
    'ALTER TABLE prestadores_servico ALTER COLUMN rg_prestador TYPE TEXT',
    'ALTER TABLE prestadores_servico ALTER COLUMN pis_nis TYPE TEXT',
    'ALTER TABLE prestadores_servico ALTER COLUMN banco TYPE TEXT',
    'ALTER TABLE prestadores_servico ALTER COLUMN agencia TYPE TEXT',
    'ALTER TABLE prestadores_servico ALTER COLUMN conta TYPE TEXT',
    'ALTER TABLE prestadores_servico ALTER COLUMN chave_pix TYPE TEXT',
    'ALTER TABLE participantes_seguro ALTER COLUMN cpf TYPE TEXT',
    'ALTER TABLE participantes_seguro ALTER COLUMN rg TYPE TEXT',

    # uma solicitacao de diaria pode ser so de Auxilio Deslocamento, sem
    # diaria nenhuma - nesse caso nao ha data de ida/retorno de viagem
    'ALTER TABLE solicitacao_diarias ALTER COLUMN data_ida DROP NOT NULL',
    'ALTER TABLE solicitacao_diarias ALTER COLUMN data_retorno DROP NOT NULL',

    # "Retirada no fornecedor" (23 caracteres) sempre passou do limite
    # antigo de varchar(20) - amplia pra sem limite fixo
    'ALTER TABLE solicitacao_alimentacoes ALTER COLUMN forma_entrega TYPE TEXT',

    # unidade de medida (catalogo de rancho) e local de entrega (rancho) sao
    # texto livre digitado - mesmo tipo de risco ja visto em outros campos
    'ALTER TABLE itens_rancho ALTER COLUMN unidade TYPE TEXT',
    'ALTER TABLE itens_solicitacao_rancho ALTER COLUMN unidade TYPE TEXT',
    'ALTER TABLE solicitacao_ranchos ALTER COLUMN local_entrega TYPE TEXT',

    # numero do voo as vezes vem com varias escalas/conexoes listadas junto,
    # nao so um codigo curto de voo unico
    'ALTER TABLE solicitacao_passagens ALTER COLUMN voo_ida_numero TYPE TEXT',
    'ALTER TABLE solicitacao_passagens ALTER COLUMN voo_volta_numero TYPE TEXT',
]
...
def criptografar_dados_sensiveis_existentes():
    """Criptografa os dados sensíveis (CPF, RG, PIS/NIS, dados bancários) que
    já existiam no banco em texto puro, de antes da criptografia existir.

    Roda a cada início do sistema, mas só tem efeito de verdade na primeira
    vez - lê o valor exatamente como está gravado, tenta descriptografar; se
    conseguir, já está migrado e pula; se não conseguir, é texto puro ainda,
    então criptografa e grava. Seguro de rodar várias vezes (idempotente) e
    seguro de interromper no meio (cada linha é uma transação própria)."""
    if not _fernet:
        print('[criptografia] CHAVE_CRIPTOGRAFIA não configurada - migração de dados existentes NÃO executada.')
        return

    tabelas_e_campos = [
        ('solicitacao_diarias', ['cpf_diarista', 'banco_diarista', 'agencia_diarista', 'conta_diarista', 'chave_pix']),
        ('solicitacao_passagens', ['cpf_passageiro', 'rg_orgao_uf_passageiro']),
        ('prestadores_servico', ['cpf_prestador', 'rg_prestador', 'pis_nis', 'banco', 'agencia', 'conta', 'chave_pix']),
        ('participantes_seguro', ['cpf', 'rg']),
    ]

    total_migrados = 0
    for tabela_nome, campos in tabelas_e_campos:
        for campo in campos:
            try:
                with db.engine.begin() as conexao:
                    linhas = conexao.execute(sa_text(
                        f"SELECT id, {campo} FROM {tabela_nome} WHERE {campo} IS NOT NULL AND {campo} != ''"
                    )).fetchall()
            except Exception as erro:
                print(f'[criptografia] não foi possível ler {tabela_nome}.{campo}: {str(erro)[:120]}')
                continue

            for id_registro, valor_atual in linhas:
                try:
                    _fernet.decrypt(valor_atual.encode())
                    continue  # já está criptografado, pula esta linha
                except (InvalidToken, ValueError, AttributeError):
                    pass  # é texto puro ainda - precisa criptografar

                valor_criptografado = _fernet.encrypt(valor_atual.encode()).decode()
                try:
                    with db.engine.begin() as conexao:
                        conexao.execute(
                            sa_text(f'UPDATE {tabela_nome} SET {campo} = :valor WHERE id = :id_registro'),
                            {'valor': valor_criptografado, 'id_registro': id_registro},
                        )
                    total_migrados += 1
                except Exception as erro:
                    print(f'[criptografia] falha ao migrar {tabela_nome}.{campo} id={id_registro}: {str(erro)[:120]}')

    if total_migrados:
        print(f'[criptografia] {total_migrados} valor(es) de dados sensíveis criptografados nesta execução.')
    else:
        print('[criptografia] nenhum dado pendente de criptografia (já migrado, ou banco vazio).')
...
if os.environ.get('DATABASE_URL'):
    with app.app_context():
        ...
        criptografar_dados_sensiveis_existentes()
        criar_indices()
        conferir_schema()
        seed_dados_iniciais()
        seed_coordenacoes()
