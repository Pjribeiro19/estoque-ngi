...
# =============================================================================
    ...
    with st.sidebar:
        ...
        # ÍCONES ATUALIZADOS: Substituição por marcadores corporativos neutros (▪) conforme exemplo limpo
        menu_opcoes = [
            "▪ Painel Geral",
            "▪ Cadastrar Produto",
            "▪ Cadastrar Categoria",
    ...
    # --- TELA: PAINEL GERAL ---
        ...
        # Cabeçalho corporativo integrado e profissional (Sem emojis)
        st.markdown("""
        ...
        # Bloco de Cartões Executivos Customizados
