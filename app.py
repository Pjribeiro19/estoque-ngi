...
def compra_materiais_form():
    ...
    if request.method == 'POST':
        ...
        # solicitacao) e e cobrada de verdade na tela de detalhe, depois de
        # criada - cada item ganha ali a propria caixinha de anexo, e o
        # Executor fica travado de concluir a compra sem isso. Aqui na
        # criacao nao ha como vincular esses anexos a um item especifico
        # ainda (o item nem tem id no banco), entao nao bloqueia o envio.
